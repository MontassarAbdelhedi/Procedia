...
function loadMerge() {
  ...
  loadGlobalScript('versioning/merge/conflictFactory/shared.js');
  loadGlobalScript('versioning/merge/conflictFactory/propertyConflicts.js');
  loadGlobalScript('versioning/merge/conflictFactory/structuralConflicts.js');
  loadGlobalScript('versioning/merge/conflictFactory/topologyConflicts.js');
  loadGlobalScript('versioning/merge/conflictFactory.js');
  loadGlobalScript('versioning/merge/layerCycleDetector.js');
  loadGlobalScript('versioning/merge/duplicateWireDetector.js');
  ...
  loadGlobalScript('versioning/merge/threeWayMerge/helpers.js');
  loadGlobalScript('versioning/merge/threeWayMerge/fieldMerge.js');
  loadGlobalScript('versioning/merge/threeWayMerge/collectionMerge.js');
  loadGlobalScript('versioning/merge/threeWayMerge/nodeMerge.js');
  loadGlobalScript('versioning/merge/threeWayMerge/wireMerge.js');
  loadGlobalScript('versioning/merge/threeWayMerge.js');
  loadGlobalScript('versioning/merge/conflictResolver/singleConflict.js');
  loadGlobalScript('versioning/merge/conflictResolver/bulkOps.js');
