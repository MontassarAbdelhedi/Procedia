// graph/nodes/nodeRenderer.js
// DEPENDS ON: graph/nodes/nodeRegistry.js, graph/nodes/nodeGeometry.js
...
var nodeRenderer = (function() {
  ...
  function drawNode(ctx, nodeData, transform, opts) {
    ...
    var showPorts   = opts.showInputPorts || false;
    var hoveredPort = opts.hoveredPort   || null;
    ...
    // ── Pending-selection ring (marquee hover, not yet committed) ─
    if (pending) {
      roundRect(ctx, sx - 2, sy - 2, sw + 4, sh + 4, CORNER_R + 2);
    ...
    // ── Property preview (first property) ────────────────────────
    var previewText = '';
