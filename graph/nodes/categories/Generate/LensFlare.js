/**
 * @file Lens Flare Generate node definition (generate/lens-flare).
 * An effector that applies the ADBE Lens Flare effect to a layer.
...
// graph/nodes/categories/Generate/LensFlare.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Lens Flare',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(LensFlareNode);