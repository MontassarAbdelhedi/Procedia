/**
 * @file Grid Generate node definition (generate/grid).
 * An effector that applies the ADBE Grid effect to a layer.
...
// graph/nodes/categories/Generate/Grid.js
...
nodeRegistry.register(GridNode);