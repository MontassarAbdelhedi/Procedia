/**
 * @file CC Light Rays Generate node definition (generate/cc-light-rays).
 * An effector that applies the CC Light Rays effect to a layer.
...
// graph/nodes/categories/Generate/CCLightRays.js
...
nodeRegistry.register(CCLightRaysNode);