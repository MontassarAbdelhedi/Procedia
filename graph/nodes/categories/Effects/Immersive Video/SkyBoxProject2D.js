/**
 * @file SkyBox Project 2D Immersive Video node definition (immersive-video/skybox-project-2d).
 * An effector that applies the Mettle SkyBox Project 2D effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxProject2D.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxProject2DNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Project 2D',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxProject2DNode);
