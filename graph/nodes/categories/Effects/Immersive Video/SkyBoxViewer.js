/**
 * @file SkyBox Viewer Immersive Video node definition (immersive-video/skybox-viewer).
 * An effector that applies the Mettle SkyBox Viewer effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxViewer.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxViewerNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Viewer',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxViewerNode);
