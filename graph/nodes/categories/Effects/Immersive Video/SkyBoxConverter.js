/**
 * @file SkyBox Converter Immersive Video node definition (immersive-video/skybox-converter).
 * An effector that applies the Mettle SkyBox Converter effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxConverter.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxConverterNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Converter',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxConverterNode);
