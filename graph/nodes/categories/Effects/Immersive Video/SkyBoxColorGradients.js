/**
 * @file SkyBox Color Gradients Immersive Video node definition (immersive-video/skybox-color-gradients).
 * An effector that applies the Mettle SkyBox Color Gradients effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxColorGradients.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxColorGradientsNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Color Gradients',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxColorGradientsNode);
