/**
 * @file SkyBox Chromatic Aberration Immersive Video node definition (immersive-video/skybox-chromatic-aberration).
 * An effector that applies the Mettle SkyBox Chromatic Aberrat effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxChromaticAberration.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxChromaticAberrationNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Chromatic Aberrat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxChromaticAberrationNode);
