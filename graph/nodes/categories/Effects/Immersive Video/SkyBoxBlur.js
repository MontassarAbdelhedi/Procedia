/**
 * @file SkyBox Blur Immersive Video node definition (immersive-video/skybox-blur).
 * An effector that applies the Mettle SkyBox Blur effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxBlur.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Blur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxBlurNode);
