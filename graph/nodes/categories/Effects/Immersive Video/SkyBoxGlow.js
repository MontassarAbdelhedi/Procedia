/**
 * @file SkyBox Glow Immersive Video node definition (immersive-video/skybox-glow).
 * An effector that applies the Mettle SkyBox Glow effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxGlow.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Glow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxGlowNode);
