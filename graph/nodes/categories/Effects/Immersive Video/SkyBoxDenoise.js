/**
 * @file SkyBox Denoise Immersive Video node definition (immersive-video/skybox-denoise).
 * An effector that applies the Mettle SkyBox Denoise effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxDenoise.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxDenoiseNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Denoise',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxDenoiseNode);
