/**
 * @file SkyBox Sharpen Immersive Video node definition (immersive-video/skybox-sharpen).
 * An effector that applies the Mettle SkyBox Sharpen effect to a layer.
...
// graph/nodes/categories/Effects/Immersive Video/SkyBoxSharpen.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SkyBoxSharpenNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Mettle SkyBox Sharpen',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SkyBoxSharpenNode);
