/**
 * @file CC Threshold RGB Stylize node definition (stylize/cc-threshold-rgb).
 * An effector that applies the CC Threshold RGB effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCThresholdRGB.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCThresholdRGBNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Threshold RGB',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCThresholdRGBNode);
