/**
 * @file Strobe Stylize node definition (stylize/strobe).
 * An effector that applies the ADBE Strobe effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Strobe.js
...
nodeRegistry.register(StrobeNode);
