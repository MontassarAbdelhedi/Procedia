/**
 * @file CS BlockLoad Stylize node definition (stylize/cs-block-load).
 * An effector that applies the CS BlockLoad effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CSBlockLoad.js
...
nodeRegistry.register(CSBlockLoadNode);
