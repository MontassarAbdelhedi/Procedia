/**
 * @file CC Glass Stylize node definition (stylize/cc-glass).
 * An effector that applies the CC Glass effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCGlass.js
...
nodeRegistry.register(CCGlassNode);
