/**
 * @file CC Plastic Stylize node definition (stylize/cc-plastic).
 * An effector that applies the CC Plastic effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCPlastic.js
...
nodeRegistry.register(CCPlasticNode);
