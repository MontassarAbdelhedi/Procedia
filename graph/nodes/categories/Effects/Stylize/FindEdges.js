/**
 * @file Find Edges Stylize node definition (stylize/find-edges).
 * An effector that applies the ADBE Find Edges effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/FindEdges.js
...
nodeRegistry.register(FindEdgesNode);
