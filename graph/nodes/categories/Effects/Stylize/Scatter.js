/**
 * @file Scatter Stylize node definition (stylize/scatter).
 * An effector that applies the ADBE Scatter effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Scatter.js
...
nodeRegistry.register(ScatterNode);
