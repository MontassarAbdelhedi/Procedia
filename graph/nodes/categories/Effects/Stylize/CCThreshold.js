/**
 * @file CC Threshold Stylize node definition (stylize/cc-threshold).
 * An effector that applies the CC Threshold effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCThreshold.js
...
nodeRegistry.register(CCThresholdNode);
