/**
 * @file Threshold 2 Stylize node definition (stylize/threshold-2).
 * An effector that applies the ADBE Threshold2 effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Threshold2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Threshold2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Threshold2Node);
