/**
 * @file Brush Strokes Stylize node definition (stylize/brush-strokes).
 * An effector that applies the ADBE Brush Strokes effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/BrushStrokes.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var BrushStrokesNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Brush Strokes',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BrushStrokesNode);
