/**
 * @file Mosaic Stylize node definition (stylize/mosaic).
 * An effector that applies the ADBE Mosaic effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Mosaic.js
...
nodeRegistry.register(MosaicNode);
