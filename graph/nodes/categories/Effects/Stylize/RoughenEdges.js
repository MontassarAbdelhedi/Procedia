/**
 * @file Roughen Edges Stylize node definition (stylize/roughen-edges).
 * An effector that applies the ADBE Roughen Edges effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/RoughenEdges.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RoughenEdgesNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Roughen Edges',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RoughenEdgesNode);
