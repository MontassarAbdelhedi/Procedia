/**
 * @file Glow 2 Stylize node definition (stylize/glow-2).
 * An effector that applies the ADBE Glo2 effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Glow2.js
...
nodeRegistry.register(Glow2Node);
