/**
 * @file CS HexTile Stylize node definition (stylize/cs-hex-tile).
 * An effector that applies the CS HexTile effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CSHexTile.js
...
nodeRegistry.register(CSHexTileNode);
