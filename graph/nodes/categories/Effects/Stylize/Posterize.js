/**
 * @file Posterize Stylize node definition (stylize/posterize).
 * An effector that applies the ADBE Posterize effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Posterize.js
...
nodeRegistry.register(PosterizeNode);
