/**
 * @file CC Mr. Smoothie Stylize node definition (stylize/cc-mr-smoothie).
 * An effector that applies the CC Mr. Smoothie effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCMrSmoothie.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCMrSmoothieNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Mr. Smoothie',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCMrSmoothieNode);
