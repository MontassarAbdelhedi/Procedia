/**
 * @file Texturize Stylize node definition (stylize/texturize).
 * An effector that applies the ADBE Texturize effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Texturize.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Texturize',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(TexturizeNode);
