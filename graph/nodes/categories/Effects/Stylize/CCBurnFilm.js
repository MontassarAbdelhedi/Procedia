/**
 * @file CC Burn Film Stylize node definition (stylize/cc-burn-film).
 * An effector that applies the CC Burn Film effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCBurnFilm.js
...
nodeRegistry.register(CCBurnFilmNode);
