/**
 * @file CC Kaleida Stylize node definition (stylize/cc-kaleida).
 * An effector that applies the CC Kaleida effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CCKaleida.js
...
nodeRegistry.register(CCKaleidaNode);
