/**
 * @file CS Vignette Stylize node definition (stylize/cs-vignette).
 * An effector that applies the CS Vignette effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/CSVignette.js
...
nodeRegistry.register(CSVignetteNode);
