/**
 * @file Cartoonify Stylize node definition (stylize/cartoonify).
 * An effector that applies the ADBE Cartoonify effect to a layer.
...
// graph/nodes/categories/Effects/Stylize/Cartoonify.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Cartoonify',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CartoonifyNode);
