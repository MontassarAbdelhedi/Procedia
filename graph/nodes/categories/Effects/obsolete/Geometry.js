/**
 * @file Geometry Obsolete node definition (geometry).
 * An effector that applies the ADBE Geometry effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Geometry.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var GeometryNode = {
  type:      'obsolete/geometry',
  label:     'Geometry',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Geometry',
  params:    'dynamic',
...
nodeRegistry.register(GeometryNode);
