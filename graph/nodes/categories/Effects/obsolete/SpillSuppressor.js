/**
 * @file Spill Suppressor Obsolete node definition (spill-suppressor).
 * An effector that applies the ADBE Spill Suppressor effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/SpillSuppressor.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SpillSuppressorNode = {
  type:      'obsolete/spill-suppressor',
  label:     'Spill Suppressor',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Spill Suppressor',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Spill Suppressor',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SpillSuppressorNode);
