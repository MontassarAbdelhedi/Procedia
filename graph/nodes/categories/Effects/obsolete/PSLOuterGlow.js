/**
 * @file PSL Outer Glow Obsolete node definition (psl-outer-glow).
 * An effector that applies the ADBE PSL Outer Glow effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLOuterGlow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLOuterGlowNode = {
  type:      'obsolete/psl-outer-glow',
  label:     'PSL Outer Glow',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Outer Glow',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Outer Glow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLOuterGlowNode);
