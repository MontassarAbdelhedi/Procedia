/**
 * @file Alpha Levels 2 Obsolete node definition (alpha-levels-2).
 * An effector that applies the ADBE Alpha Levels2 effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/AlphaLevels2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AlphaLevels2Node = {
  type:      'obsolete/alpha-levels-2',
  label:     'Alpha Levels 2',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Alpha Levels2',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Alpha Levels2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AlphaLevels2Node);
