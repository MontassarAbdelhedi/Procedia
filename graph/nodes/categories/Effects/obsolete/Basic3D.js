/**
 * @file Basic 3D Obsolete node definition (basic-3d).
 * An effector that applies the ADBE Basic 3D effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Basic3D.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var Basic3DNode = {
  type:      'obsolete/basic-3d',
  label:     'Basic 3D',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(Basic3DNode);
