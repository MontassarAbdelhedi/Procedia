/**
 * @file Refine Matte Obsolete node definition (refine-matte).
 * An effector that applies the ADBE RefineMatte effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/RefineMatte.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RefineMatteNode = {
  type:      'obsolete/refine-matte',
  label:     'Refine Matte',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE RefineMatte',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE RefineMatte',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RefineMatteNode);
