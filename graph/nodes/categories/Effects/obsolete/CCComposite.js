/**
 * @file CC Composite Obsolete node definition (cc-composite).
 * An effector that applies the CC Composite effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCComposite.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCCompositeNode = {
  type:      'obsolete/cc-composite',
  label:     'CC Composite',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'CC Composite',
  params:    'dynamic',
...
nodeRegistry.register(CCCompositeNode);
