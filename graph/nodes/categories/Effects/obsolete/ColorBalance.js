/**
 * @file Color Balance Obsolete node definition (color-balance).
 * An effector that applies the ADBE Color Balance effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/ColorBalance.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorBalanceNode = {
  type:      'obsolete/color-balance',
  label:     'Color Balance',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
