/**
 * @file Samurai Obsolete node definition (samurai).
 * An effector that applies the ADBE Samurai effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Samurai.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SamuraiNode = {
  type:      'obsolete/samurai',
  label:     'Samurai',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(SamuraiNode);
