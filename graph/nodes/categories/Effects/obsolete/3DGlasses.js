/**
 * @file 3D Glasses Obsolete node definition (3d-glasses).
 * An effector that applies the ADBE 3D Glasses effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/3DGlasses.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var Glasses3DNode = {
  type:      'obsolete/3d-glasses',
  label:     '3D Glasses',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE 3D Glasses',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE 3D Glasses',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Glasses3DNode);
