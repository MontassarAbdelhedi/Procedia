/**
 * @file Alpha Levels 3 Obsolete node definition (alpha-levels-3).
 * An effector that applies the ADBE Alpha Levels3 effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/AlphaLevels3.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AlphaLevels3Node = {
  type:      'obsolete/alpha-levels-3',
  label:     'Alpha Levels 3',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Alpha Levels3',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Alpha Levels3',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AlphaLevels3Node);
