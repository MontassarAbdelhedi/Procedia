/**
 * @file Path Text Obsolete node definition (path-text).
 * An effector that applies the ADBE Path Text effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PathText.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PathTextNode = {
  type:      'obsolete/path-text',
  label:     'Path Text',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Path Text',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Path Text',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PathTextNode);
