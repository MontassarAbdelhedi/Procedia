/**
 * @file Noise HLS Obsolete node definition (noise-hls).
 * An effector that applies the ADBE Noise HLS effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/NoiseHLS.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var NoiseHLSNode = {
  type:      'obsolete/noise-hls',
  label:     'Noise HLS',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise HLS',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseHLSNode);
