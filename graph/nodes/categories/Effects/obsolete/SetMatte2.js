/**
 * @file Set Matte 2 Obsolete node definition (set-matte-2).
 * An effector that applies the ADBE Set Matte2 effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/SetMatte2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SetMatte2Node = {
  type:      'obsolete/set-matte-2',
  label:     'Set Matte 2',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Set Matte2',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Set Matte2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SetMatte2Node);
