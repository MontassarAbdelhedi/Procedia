/**
 * @file Paint Obsolete node definition (paint).
 * An effector that applies the ADBE Paint effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Paint.js
...
nodeRegistry.register(PaintNode);
