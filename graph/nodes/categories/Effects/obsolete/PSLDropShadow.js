/**
 * @file PSL Drop Shadow Obsolete node definition (psl-drop-shadow).
 * An effector that applies the ADBE PSL Drop Shadow effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLDropShadow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLDropShadowNode = {
  type:      'obsolete/psl-drop-shadow',
  label:     'PSL Drop Shadow',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Drop Shadow',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Drop Shadow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLDropShadowNode);
