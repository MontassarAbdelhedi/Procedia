/**
 * @file PSL Inner Shadow Obsolete node definition (psl-inner-shadow).
 * An effector that applies the ADBE PSL Inner Shadow effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLInnerShadow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLInnerShadowNode = {
  type:      'obsolete/psl-inner-shadow',
  label:     'PSL Inner Shadow',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Inner Shadow',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Inner Shadow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLInnerShadowNode);
