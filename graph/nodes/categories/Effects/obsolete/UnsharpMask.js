/**
 * @file Unsharp Mask Obsolete node definition (unsharp-mask).
 * An effector that applies the ADBE Unsharp Mask effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/UnsharpMask.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var UnsharpMaskNode = {
  type:      'obsolete/unsharp-mask',
  label:     'Unsharp Mask',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Unsharp Mask',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(UnsharpMaskNode);
