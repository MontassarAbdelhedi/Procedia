/**
 * @file Basic Text 2 Obsolete node definition (basic-text-2).
 * An effector that applies the ADBE Basic Text2 effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/BasicText2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var BasicText2Node = {
  type:      'obsolete/basic-text-2',
  label:     'Basic Text 2',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Basic Text2',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Basic Text2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BasicText2Node);
