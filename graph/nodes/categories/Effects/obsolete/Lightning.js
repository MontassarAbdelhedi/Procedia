/**
 * @file Lightning Obsolete node definition (lightning).
 * An effector that applies the ADBE Lightning effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Lightning.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var LightningNode = {
  type:      'obsolete/lightning',
  label:     'Lightning',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Lightning',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Lightning',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(LightningNode);
