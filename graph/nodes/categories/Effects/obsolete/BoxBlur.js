/**
 * @file Box Blur Obsolete node definition (box-blur).
 * An effector that applies the ADBE Box Blur effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/BoxBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var BoxBlurNode = {
  type:      'obsolete/box-blur',
  label:     'Box Blur',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(BoxBlurNode);
