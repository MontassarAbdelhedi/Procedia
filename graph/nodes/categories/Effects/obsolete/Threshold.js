/**
 * @file Threshold Obsolete node definition (threshold).
 * An effector that applies the ADBE Threshold effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Threshold.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ThresholdNode = {
  type:      'obsolete/threshold',
  label:     'Threshold',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Threshold',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Threshold',
        propMatchName:   key,
        value:           value
      }
    };
