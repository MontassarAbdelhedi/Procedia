/**
 * @file Color Key Obsolete node definition (color-key).
 * An effector that applies the ADBE Color Key effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/ColorKey.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorKeyNode = {
  type:      'obsolete/color-key',
  label:     'Color Key',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Key',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorKeyNode);
