/**
 * @file Reduce Interlace Flicker Obsolete node definition (reduce-interlace-flicker).
 * An effector that applies the ADBE Reduce Interlace Flicker effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/ReduceInterlaceFlicker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ReduceInterlaceFlickerNode = {
  type:      'obsolete/reduce-interlace-flicker',
  label:     'Reduce Interlace Flicker',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Reduce Interlace Flicker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Reduce Interlace Flicker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ReduceInterlaceFlickerNode);
