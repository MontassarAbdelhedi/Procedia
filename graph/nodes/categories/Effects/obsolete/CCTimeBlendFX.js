/**
 * @file CC Time Blend FX Obsolete node definition (cc-time-blend-fx).
 * An effector that applies the CC Time Blend FX effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCTimeBlendFX.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCTimeBlendFXNode = {
  type:      'obsolete/cc-time-blend-fx',
  label:     'CC Time Blend FX',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'CC Time Blend FX',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Time Blend FX',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCTimeBlendFXNode);
