/**
 * @file CC PS Classic Obsolete node definition (cc-ps-classic).
 * An effector that applies the CC PS Classic effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCPSClassic.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCPSClassicNode = {
  type:      'obsolete/cc-ps-classic',
  label:     'CC PS Classic',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'CC PS Classic',
  params:    'dynamic',
...
nodeRegistry.register(CCPSClassicNode);
