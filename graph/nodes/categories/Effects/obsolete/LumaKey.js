/**
 * @file Luma Key Obsolete node definition (luma-key).
 * An effector that applies the ADBE Luma Key effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/LumaKey.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var LumaKeyNode = {
  type:      'obsolete/luma-key',
  label:     'Luma Key',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(LumaKeyNode);
