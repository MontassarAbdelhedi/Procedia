/**
 * @file Photo Filter Obsolete node definition (photo-filter).
 * An effector that applies the ADBE Photo Filter effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PhotoFilter.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PhotoFilterNode = {
  type:      'obsolete/photo-filter',
  label:     'Photo Filter',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Photo Filter',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PhotoFilterNode);
