/**
 * @file PSL Bevel Emboss Obsolete node definition (psl-bevel-emboss).
 * An effector that applies the ADBE PSL Bevel Emboss effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLBevelEmboss.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLBevelEmbossNode = {
  type:      'obsolete/psl-bevel-emboss',
  label:     'PSL Bevel Emboss',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Bevel Emboss',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Bevel Emboss',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLBevelEmbossNode);
