/**
 * @file CC Time Blend Obsolete node definition (cc-time-blend).
 * An effector that applies the CC Time Blend effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCTimeBlend.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCTimeBlendNode = {
  type:      'obsolete/cc-time-blend',
  label:     'CC Time Blend',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'CC Time Blend',
  params:    'dynamic',
...
nodeRegistry.register(CCTimeBlendNode);
