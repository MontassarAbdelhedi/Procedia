/**
 * @file CC Snow Obsolete node definition (cc-snow).
 * An effector that applies the CC Snow effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCSnow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCSnowNode = {
  type:      'obsolete/cc-snow',
  label:     'CC Snow',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(CCSnowNode);
