/**
 * @file Pro Levels Obsolete node definition (pro-levels).
 * An effector that applies the ADBE Pro Levels effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/ProLevels.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ProLevelsNode = {
  type:      'obsolete/pro-levels',
  label:     'Pro Levels',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Pro Levels',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Pro Levels',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ProLevelsNode);
