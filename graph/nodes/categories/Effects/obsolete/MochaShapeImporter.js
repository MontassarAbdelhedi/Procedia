/**
 * @file Mocha Shape Importer Obsolete node definition (mocha-shape-importer).
 * An effector that applies the ISL MochaShapeImporter effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/MochaShapeImporter.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var MochaShapeImporterNode = {
  type:      'obsolete/mocha-shape-importer',
  label:     'Mocha Shape Importer',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ISL MochaShapeImporter',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ISL MochaShapeImporter',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(MochaShapeImporterNode);
