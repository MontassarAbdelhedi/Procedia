/**
 * @file Noise HLS Auto Obsolete node definition (noise-hls-auto).
 * An effector that applies the ADBE Noise HLS Auto effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/NoiseHLSAuto.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var NoiseHLSAutoNode = {
  type:      'obsolete/noise-hls-auto',
  label:     'Noise HLS Auto',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Noise HLS Auto',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise HLS Auto',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseHLSAutoNode);
