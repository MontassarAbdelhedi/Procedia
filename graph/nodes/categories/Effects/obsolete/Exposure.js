/**
 * @file Exposure Obsolete node definition (exposure).
 * An effector that applies the ADBE Exposure effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/Exposure.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ExposureNode = {
  type:      'obsolete/exposure',
  label:     'Exposure',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Exposure',
  params:    'dynamic',
...
nodeRegistry.register(ExposureNode);
