/**
 * @file FreePin 3 Obsolete node definition (free-pin-3).
 * An effector that applies the ADBE FreePin3 effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/FreePin3.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var FreePin3Node = {
  type:      'obsolete/free-pin-3',
  label:     'FreePin 3',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(FreePin3Node);
