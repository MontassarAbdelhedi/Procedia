/**
 * @file PSL Inner Glow Obsolete node definition (psl-inner-glow).
 * An effector that applies the ADBE PSL Inner Glow effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLInnerGlow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLInnerGlowNode = {
  type:      'obsolete/psl-inner-glow',
  label:     'PSL Inner Glow',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Inner Glow',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Inner Glow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLInnerGlowNode);
