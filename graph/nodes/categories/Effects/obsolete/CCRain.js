/**
 * @file CC Rain Obsolete node definition (cc-rain).
 * An effector that applies the CC Rain effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCRain.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCRainNode = {
  type:      'obsolete/cc-rain',
  label:     'CC Rain',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
...
nodeRegistry.register(CCRainNode);
