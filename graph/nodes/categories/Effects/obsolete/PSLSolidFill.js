/**
 * @file PSL Solid Fill Obsolete node definition (psl-solid-fill).
 * An effector that applies the ADBE PSL Solid Fill effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/PSLSolidFill.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSLSolidFillNode = {
  type:      'obsolete/psl-solid-fill',
  label:     'PSL Solid Fill',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE PSL Solid Fill',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PSL Solid Fill',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSLSolidFillNode);
