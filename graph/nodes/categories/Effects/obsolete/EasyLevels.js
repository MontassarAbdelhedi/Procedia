/**
 * @file Easy Levels Obsolete node definition (easy-levels).
 * An effector that applies the ADBE Easy Levels effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/EasyLevels.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var EasyLevelsNode = {
  type:      'obsolete/easy-levels',
  label:     'Easy Levels',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Easy Levels',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Easy Levels',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(EasyLevelsNode);
