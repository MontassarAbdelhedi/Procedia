/**
 * @file Noise Alpha Obsolete node definition (noise-alpha).
 * An effector that applies the ADBE Noise Alpha effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/NoiseAlpha.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var NoiseAlphaNode = {
  type:      'obsolete/noise-alpha',
  label:     'Noise Alpha',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise Alpha',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseAlphaNode);
