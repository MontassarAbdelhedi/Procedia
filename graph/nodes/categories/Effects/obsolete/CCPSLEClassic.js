/**
 * @file CC PS LE Classic Obsolete node definition (cc-ps-le-classic).
 * An effector that applies the CC PS LE Classic effect to a layer.
...
// graph/nodes/categories/Effects/obsolete/CCPSLEClassic.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCPSLEClassicNode = {
  type:      'obsolete/cc-ps-le-classic',
  label:     'CC PS LE Classic',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'CC PS LE Classic',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC PS LE Classic',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCPSLEClassicNode);
