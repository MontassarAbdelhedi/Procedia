/**
 * @file CS Rainfall Simulation node definition (simulation/cs-rainfall).
 * An effector that applies the CSRainfall effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CSRainfall.js
...
nodeRegistry.register(CSRainfallNode);
