/**
 * @file CC Pixel Polly Simulation node definition (simulation/cc-pixel-polly).
 * An effector that applies the CC Pixel Polly effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCPixelPolly.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCPixelPollyNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Pixel Polly',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCPixelPollyNode);
