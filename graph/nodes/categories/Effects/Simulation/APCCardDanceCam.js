/**
 * @file APC Card Dance Cam Simulation node definition (simulation/apc-card-dance-cam).
 * An effector that applies the APC CardDanceCam effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/APCCardDanceCam.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var APCCardDanceCamNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'APC CardDanceCam',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(APCCardDanceCamNode);
