/**
 * @file APC Shatter Simulation node definition (simulation/apc-shatter).
 * An effector that applies the APC Shatter effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/APCShatter.js
...
nodeRegistry.register(APCShatterNode);
