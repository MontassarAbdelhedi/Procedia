/**
 * @file APC Caustics Simulation node definition (simulation/apc-caustics).
 * An effector that applies the APC Caustics effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/APCCaustics.js
...
nodeRegistry.register(APCCausticsNode);
