/**
 * @file CC Drizzle Simulation node definition (simulation/cc-drizzle).
 * An effector that applies the CC Drizzle effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCDrizzle.js
...
nodeRegistry.register(CCDrizzleNode);
