/**
 * @file APC Foam Simulation node definition (simulation/apc-foam).
 * An effector that applies the APC Foam effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/APCFoam.js
...
nodeRegistry.register(APCFoamNode);
