/**
 * @file CC Hair Simulation node definition (simulation/cc-hair).
 * An effector that applies the CC Hair effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCHair.js
...
nodeRegistry.register(CCHairNode);
