/**
 * @file CC Bubbles Simulation node definition (simulation/cc-bubbles).
 * An effector that applies the CC Bubbles effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCBubbles.js
...
nodeRegistry.register(CCBubblesNode);
