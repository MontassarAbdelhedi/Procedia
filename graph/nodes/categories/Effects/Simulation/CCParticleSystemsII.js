/**
 * @file CC Particle Systems II Simulation node definition (simulation/cc-particle-systems-ii).
 * An effector that applies the CC Particle Systems II effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCParticleSystemsII.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCParticleSystemsIINode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Particle Systems II',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCParticleSystemsIINode);
