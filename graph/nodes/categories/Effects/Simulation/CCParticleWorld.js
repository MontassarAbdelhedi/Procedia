/**
 * @file CC Particle World Simulation node definition (simulation/cc-particle-world).
 * An effector that applies the CC Particle World effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCParticleWorld.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCParticleWorldNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Particle World',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCParticleWorldNode);
