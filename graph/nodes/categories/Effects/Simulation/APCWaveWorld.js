/**
 * @file APC Wave World Simulation node definition (simulation/apc-wave-world).
 * An effector that applies the APC Wave World effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/APCWaveWorld.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var APCWaveWorldNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'APC Wave World',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(APCWaveWorldNode);
