/**
 * @file Playground Simulation node definition (simulation/playground).
 * An effector that applies the ADBE Playgnd effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/Playground.js
...
nodeRegistry.register(PlaygroundNode);
