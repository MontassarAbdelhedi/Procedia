/**
 * @file CS Snowfall Simulation node definition (simulation/cs-snowfall).
 * An effector that applies the CSSnowfall effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CSSnowfall.js
...
nodeRegistry.register(CSSnowfallNode);
