/**
 * @file CC Ball Action Simulation node definition (simulation/cc-ball-action).
 * An effector that applies the CC Ball Action effect to a layer.
...
// graph/nodes/categories/Effects/Simulation/CCBallAction.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCBallActionNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Ball Action',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCBallActionNode);
