/**
 * @file IDentifier 3D Channel node definition (3d-channel/identifier).
 * An effector that applies the IDentifier effect to a layer.
...
// graph/nodes/categories/Effects/3D Channel/IDentifier.js
...
nodeRegistry.register(IDentifierNode);
