/**
 * @file Depth Matte 3D Channel node definition (3d-channel/depth-matte).
 * An effector that applies the ADBE DEPTH MATTE effect to a layer.
...
// graph/nodes/categories/Effects/3D Channel/DepthMatte.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DEPTH MATTE',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DepthMatteNode);
