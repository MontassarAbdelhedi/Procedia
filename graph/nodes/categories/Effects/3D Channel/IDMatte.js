/**
 * @file ID Matte 3D Channel node definition (3d-channel/id-matte).
 * An effector that applies the ADBE ID MATTE effect to a layer.
...
// graph/nodes/categories/Effects/3D Channel/IDMatte.js
...
nodeRegistry.register(IDMatteNode);
