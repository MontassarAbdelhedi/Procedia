/**
 * @file Cryptomatte 3D Channel node definition (3d-channel/cryptomatte).
 * An effector that applies the Cryptomatte effect to a layer.
...
// graph/nodes/categories/Effects/3D Channel/Cryptomatte.js
...
nodeRegistry.register(CryptomatteNode);
