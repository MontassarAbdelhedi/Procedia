/**
 * @file Fog 3D 3D Channel node definition (3d-channel/fog-3d).
 * An effector that applies the ADBE FOG_3D effect to a layer.
...
// graph/nodes/categories/Effects/3D Channel/Fog3D.js
...
nodeRegistry.register(Fog3DNode);
