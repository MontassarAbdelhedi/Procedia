/**
 * @file Set Channels Channel node definition (channel/set-channels).
 * An effector that applies the ADBE Set Channels effect to a layer.
...
// graph/nodes/categories/Effects/Channel/SetChannels.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Set Channels',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SetChannelsNode);
