/**
 * @file Set Matte 3 Channel node definition (channel/set-matte-3).
 * An effector that applies the ADBE Set Matte3 effect to a layer.
...
// graph/nodes/categories/Effects/Channel/SetMatte3.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Set Matte3',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SetMatte3Node);
