/**
 * @file Arithmetic Channel node definition (channel/arithmetic).
 * An effector that applies the ADBE Arithmetic effect to a layer.
...
// graph/nodes/categories/Effects/Channel/Arithmetic.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Arithmetic',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ArithmeticNode);
