/**
 * @file Solid Composite Channel node definition (channel/solid-composite).
 * An effector that applies the ADBE Solid Composite effect to a layer.
...
// graph/nodes/categories/Effects/Channel/SolidComposite.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SolidCompositeNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Solid Composite',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SolidCompositeNode);
