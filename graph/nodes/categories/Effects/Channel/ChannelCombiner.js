/**
 * @file Channel Combiner Channel node definition (channel/channel-combiner).
 * An effector that applies the ADBE Channel Combiner effect to a layer.
...
// graph/nodes/categories/Effects/Channel/ChannelCombiner.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ChannelCombinerNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Channel Combiner',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ChannelCombinerNode);
