/**
 * @file Remove Color Matting Channel node definition (channel/remove-color-matting).
 * An effector that applies the ADBE Remove Color Matting effect to a layer.
...
// graph/nodes/categories/Effects/Channel/RemoveColorMatting.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RemoveColorMattingNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Remove Color Matting',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RemoveColorMattingNode);
