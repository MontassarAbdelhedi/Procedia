/**
 * @file Calculations Channel node definition (channel/calculations).
 * An effector that applies the ADBE Calculations effect to a layer.
...
// graph/nodes/categories/Effects/Channel/Calculations.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CalculationsNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Calculations',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CalculationsNode);
