/**
 * @file CS Composite Channel node definition (channel/cs-composite).
 * An effector that applies the CS Composite effect to a layer.
...
// graph/nodes/categories/Effects/Channel/CSComposite.js
...
nodeRegistry.register(CSCompositeNode);
