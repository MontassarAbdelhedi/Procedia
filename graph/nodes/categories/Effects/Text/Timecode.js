/**
 * @file Timecode Text node definition (text/timecode).
 * An effector that applies the ADBE Timecode effect to a layer.
...
// graph/nodes/categories/Effects/Text/Timecode.js
...
nodeRegistry.register(TimecodeNode);
