/**
 * @file Numbers 2 Text node definition (text/numbers-2).
 * An effector that applies the ADBE Numbers2 effect to a layer.
...
// graph/nodes/categories/Effects/Text/Numbers2.js
...
nodeRegistry.register(Numbers2Node);
