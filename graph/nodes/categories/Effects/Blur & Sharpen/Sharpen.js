/**
 * @file Sharpen blur node definition (blur-sharpen/sharpen).
 * An effector that applies the ADBE Sharpen effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/Sharpen.js
...
var SharpenNode = {
  ...
  /**
   * Applies the ADBE Sharpen effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Sharpen effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Sharpen effect in AE.
