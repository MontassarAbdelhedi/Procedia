/**
 * @file Gaussian Blur 2 blur node definition (blur-sharpen/gaussian-blur-2).
 * An effector that applies the ADBE Gaussian Blur 2 effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/GaussianBlur2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var GaussianBlur2Node = {
  ...
  /**
   * Applies the ADBE Gaussian Blur 2 effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Gaussian Blur 2 effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Gaussian Blur 2 effect in AE.
...
nodeRegistry.register(GaussianBlur2Node);
