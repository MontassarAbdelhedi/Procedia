/**
 * @file CC Radial Fast Blur blur node definition (blur-sharpen/cc-radial-fast-blur).
 * An effector that applies the CC Radial Fast Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/CCRadialFastBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCRadialFastBlurNode = {
  ...
  /**
   * Applies the CC Radial Fast Blur effect to the upstream layer.
  ...
  /**
   * Removes the CC Radial Fast Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the CC Radial Fast Blur effect in AE.
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Radial Fast Blur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCRadialFastBlurNode);
