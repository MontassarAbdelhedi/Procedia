/**
 * @file Gaussian Blur blur node definition (blur-sharpen/gaussian-blur).
 * An effector that applies the ADBE Gaussian Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/GaussianBlur.js
...
var GaussianBlurNode = {
  ...
  /**
   * Applies the ADBE Gaussian Blur effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Gaussian Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Gaussian Blur effect in AE.
