/**
 * @file Box Blur 2 blur node definition (blur-sharpen/box-blur-2).
 * An effector that applies the ADBE Box Blur2 effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/BoxBlur2.js
...
var BoxBlur2Node = {
  ...
  /**
   * Applies the ADBE Box Blur2 effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Box Blur2 effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Box Blur2 effect in AE.
...
nodeRegistry.register(BoxBlur2Node);
