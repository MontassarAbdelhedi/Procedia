/**
 * @file Radial Blur blur node definition (blur-sharpen/radial-blur).
 * An effector that applies the ADBE Radial Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/RadialBlur.js
...
var RadialBlurNode = {
  ...
  /**
   * Applies the ADBE Radial Blur effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Radial Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Radial Blur effect in AE.
...
nodeRegistry.register(RadialBlurNode);
