/**
 * @file CC Vector Blur blur node definition (blur-sharpen/cc-vector-blur).
 * An effector that applies the CC Vector Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/CCVectorBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCVectorBlurNode = {
  ...
  /**
   * Applies the CC Vector Blur effect to the upstream layer.
  ...
  /**
   * Removes the CC Vector Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the CC Vector Blur effect in AE.
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Vector Blur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCVectorBlurNode);
