/**
 * @file Camera Lens Blur blur node definition (blur-sharpen/camera-lens-blur).
 * An effector that applies the ADBE Camera Lens Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/CameraLensBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CameraLensBlurNode = {
  ...
  /**
   * Applies the ADBE Camera Lens Blur effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Camera Lens Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Camera Lens Blur effect in AE.
...
nodeRegistry.register(CameraLensBlurNode);
