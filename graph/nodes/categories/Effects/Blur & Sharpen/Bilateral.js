/**
 * @file Bilateral blur node definition (blur-sharpen/bilateral).
 * An effector that applies the ADBE Bilateral effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/Bilateral.js
...
var BilateralNode = {
  ...
  /**
   * Applies the ADBE Bilateral effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Bilateral effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Bilateral effect in AE.
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Bilateral',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BilateralNode);
