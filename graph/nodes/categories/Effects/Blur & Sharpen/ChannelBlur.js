/**
 * @file Channel Blur blur node definition (blur-sharpen/channel-blur).
 * An effector that applies the ADBE Channel Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/ChannelBlur.js
...
var ChannelBlurNode = {
  ...
  /**
   * Applies the ADBE Channel Blur effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Channel Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Channel Blur effect in AE.
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Channel Blur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ChannelBlurNode);
