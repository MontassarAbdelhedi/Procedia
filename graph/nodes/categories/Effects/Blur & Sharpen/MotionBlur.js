/**
 * @file Motion Blur blur node definition (blur-sharpen/motion-blur).
 * An effector that applies the ADBE Motion Blur effect to a layer.
...
// graph/nodes/categories/Effects/Blur & Sharpen/MotionBlur.js
...
var MotionBlurNode = {
  ...
  /**
   * Applies the ADBE Motion Blur effect to the upstream layer.
  ...
  /**
   * Removes the ADBE Motion Blur effect from the upstream layer.
   * @param {Object} nodeData - The full node data object.
   * @param {string} hostingCompUUID - UUID of the hosting composition.
  ...
  /**
   * Updates a single property on the ADBE Motion Blur effect in AE.
...
nodeRegistry.register(MotionBlurNode);
