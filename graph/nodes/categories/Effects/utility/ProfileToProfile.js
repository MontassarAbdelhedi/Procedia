/**
 * @file Profile To Profile Utility node definition (utility/profile-to-profile).
 * An effector that applies the ADBE ProfileToProfile effect to a layer.
...
// graph/nodes/categories/Effects/Utility/ProfileToProfile.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ProfileToProfileNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE ProfileToProfile',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ProfileToProfileNode);
