/**
 * @file HDR Tone Map Utility node definition (utility/hdr-tone-map).
 * An effector that applies the ADBE HDR ToneMap effect to a layer.
...
// graph/nodes/categories/Effects/Utility/HDRToneMap.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE HDR ToneMap',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(HDRToneMapNode);
