/**
 * @file CC Overbrights Utility node definition (utility/cc-overbrights).
 * An effector that applies the CC Overbrights effect to a layer.
...
// graph/nodes/categories/Effects/Utility/CCOverbrights.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCOverbrightsNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Overbrights',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCOverbrightsNode);
