/**
 * @file Grow Bounds Utility node definition (utility/grow-bounds).
 * An effector that applies the ADBE GROW BOUNDS effect to a layer.
...
// graph/nodes/categories/Effects/Utility/GrowBounds.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE GROW BOUNDS',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(GrowBoundsNode);
