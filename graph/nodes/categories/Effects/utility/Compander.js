/**
 * @file Compander Utility node definition (utility/compander).
 * An effector that applies the ADBE Compander effect to a layer.
...
// graph/nodes/categories/Effects/Utility/Compander.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Compander',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CompanderNode);
