/**
 * @file Refine Matte 2 Matte node definition (matte/refine-matte-2).
 * An effector that applies the ADBE RefineMatte2 effect to a layer.
...
// graph/nodes/categories/Effects/Matte/RefineMatte2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RefineMatte2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE RefineMatte2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RefineMatte2Node);
