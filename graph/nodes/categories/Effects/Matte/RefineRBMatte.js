/**
 * @file Refine RB Matte Matte node definition (matte/refine-rb-matte).
 * An effector that applies the ADBE RefineRBMatte effect to a layer.
...
// graph/nodes/categories/Effects/Matte/RefineRBMatte.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RefineRBMatteNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE RefineRBMatte',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RefineRBMatteNode);
