/**
 * @file Matte Choker Matte node definition (matte/matte-choker).
 * An effector that applies the ADBE Matte Choker effect to a layer.
...
// graph/nodes/categories/Effects/Matte/MatteChoker.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Matte Choker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(MatteChokerNode);
