/**
 * @file Aud Stereo Mixer audio node definition (audio/aud-stereo-mixer).
 * An effector that applies the ADBE Aud Stereo Mixer effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudStereoMixer.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AudStereoMixerNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud Stereo Mixer',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudStereoMixerNode);
