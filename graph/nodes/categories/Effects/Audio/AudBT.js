/**
 * @file Aud BT audio node definition (audio/aud-bt).
 * An effector that applies the ADBE Aud BT effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudBT.js
...
nodeRegistry.register(AudBTNode);
