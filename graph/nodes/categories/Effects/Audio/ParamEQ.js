/**
 * @file Param EQ audio node definition (audio/param-eq).
 * An effector that applies the ADBE Param EQ effect to a layer.
...
// graph/nodes/categories/Effects/Audio/ParamEQ.js
...
nodeRegistry.register(ParamEQNode);
