/**
 * @file Aud Flange audio node definition (audio/aud-flange).
 * An effector that applies the ADBE Aud_Flange effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudFlange.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud_Flange',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudFlangeNode);
