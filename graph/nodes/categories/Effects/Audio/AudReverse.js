/**
 * @file Aud Reverse audio node definition (audio/aud-reverse).
 * An effector that applies the ADBE Aud Reverse effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudReverse.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud Reverse',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudReverseNode);
