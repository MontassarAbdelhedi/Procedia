/**
 * @file Aud Reverb audio node definition (audio/aud-reverb).
 * An effector that applies the ADBE Aud Reverb effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudReverb.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud Reverb',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudReverbNode);
