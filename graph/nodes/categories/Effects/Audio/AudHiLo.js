/**
 * @file Aud HiLo audio node definition (audio/aud-hi-lo).
 * An effector that applies the ADBE Aud HiLo effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudHiLo.js
...
nodeRegistry.register(AudHiLoNode);
