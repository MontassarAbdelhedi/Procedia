/**
 * @file Aud Modulator audio node definition (audio/aud-modulator).
 * An effector that applies the ADBE Aud Modulator effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudModulator.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AudModulatorNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud Modulator',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudModulatorNode);
