/**
 * @file Aud Delay audio node definition (audio/aud-delay).
 * An effector that applies the ADBE Aud Delay effect to a layer.
...
// graph/nodes/categories/Effects/Audio/AudDelay.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Aud Delay',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AudDelayNode);
