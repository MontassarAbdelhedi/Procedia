/**
 * @file ADBE DE Random Scale Uncategorized node definition (uncategorized/adbe-de-random-scale).
 * An effector that applies the ADBE DE Random Scale effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Scale.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomScaleNode = {
  type:      'uncategorized/adbe-de-random-scale',
  label:     'ADBE DE Random Scale',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Scale',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Scale',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomScaleNode);
