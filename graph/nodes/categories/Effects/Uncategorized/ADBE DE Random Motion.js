/**
 * @file ADBE DE Random Motion Uncategorized node definition (uncategorized/adbe-de-random-motion).
 * An effector that applies the ADBE DE Random Motion effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Motion.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomMotionNode = {
  type:      'uncategorized/adbe-de-random-motion',
  label:     'ADBE DE Random Motion',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Motion',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Motion',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomMotionNode);
