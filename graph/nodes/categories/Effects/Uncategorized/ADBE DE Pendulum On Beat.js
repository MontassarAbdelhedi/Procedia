/**
 * @file ADBE DE Pendulum On Beat Uncategorized node definition (uncategorized/adbe-de-pendulum-on-beat).
 * An effector that applies the ADBE DE Pendulum On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pendulum On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPendulumOnBeatNode = {
  type:      'uncategorized/adbe-de-pendulum-on-beat',
  label:     'ADBE DE Pendulum On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pendulum On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pendulum On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPendulumOnBeatNode);
