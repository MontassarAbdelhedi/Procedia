/**
 * @file ADBE CM FlyToInset Uncategorized node definition (uncategorized/adbe-cm-flytoinset).
 * An effector that applies the ADBE CM FlyToInset effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM FlyToInset.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMFlyToInsetNode = {
  type:      'uncategorized/adbe-cm-flytoinset',
  label:     'ADBE CM FlyToInset',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM FlyToInset',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM FlyToInset',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMFlyToInsetNode);
