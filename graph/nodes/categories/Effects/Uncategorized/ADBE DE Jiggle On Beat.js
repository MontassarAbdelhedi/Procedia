/**
 * @file ADBE DE Jiggle On Beat Uncategorized node definition (uncategorized/adbe-de-jiggle-on-beat).
 * An effector that applies the ADBE DE Jiggle On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Jiggle On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEJiggleOnBeatNode = {
  type:      'uncategorized/adbe-de-jiggle-on-beat',
  label:     'ADBE DE Jiggle On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Jiggle On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Jiggle On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEJiggleOnBeatNode);
