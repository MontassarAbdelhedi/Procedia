/**
 * @file ADBE CM Zoom2DSpin Uncategorized node definition (uncategorized/adbe-cm-zoom2dspin).
 * An effector that applies the ADBE CM Zoom2DSpin effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM Zoom2DSpin.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMZoom2DSpinNode = {
  type:      'uncategorized/adbe-cm-zoom2dspin',
  label:     'ADBE CM Zoom2DSpin',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM Zoom2DSpin',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM Zoom2DSpin',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMZoom2DSpinNode);
