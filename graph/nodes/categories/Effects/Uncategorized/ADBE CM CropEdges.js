/**
 * @file ADBE CM CropEdges Uncategorized node definition (uncategorized/adbe-cm-cropedges).
 * An effector that applies the ADBE CM CropEdges effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM CropEdges.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMCropEdgesNode = {
  type:      'uncategorized/adbe-cm-cropedges',
  label:     'ADBE CM CropEdges',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM CropEdges',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM CropEdges',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMCropEdgesNode);
