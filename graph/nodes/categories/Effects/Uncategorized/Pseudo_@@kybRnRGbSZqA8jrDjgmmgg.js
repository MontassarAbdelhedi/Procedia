/**
 * @file Pseudo/@@kybRnRGbSZqA8jrDjgmmgg Uncategorized node definition (uncategorized/pseudo-kybrnrgbszqa8jrdjgmmgg).
 * An effector that applies the Pseudo/@@kybRnRGbSZqA8jrDjgmmgg effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_@@kybRnRGbSZqA8jrDjgmmgg.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudokybRnRGbSZqA8jrDjgmmggNode = {
  type:      'uncategorized/pseudo-kybrnrgbszqa8jrdjgmmgg',
  label:     'Pseudo/@@kybRnRGbSZqA8jrDjgmmgg',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/@@kybRnRGbSZqA8jrDjgmmgg',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/@@kybRnRGbSZqA8jrDjgmmgg',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudokybRnRGbSZqA8jrDjgmmggNode);
