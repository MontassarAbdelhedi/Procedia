/**
 * @file ADBE DE Random Motion 1D Uncategorized node definition (uncategorized/adbe-de-random-motion-1d).
 * An effector that applies the ADBE DE Random Motion 1D effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Motion 1D.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomMotion1DNode = {
  type:      'uncategorized/adbe-de-random-motion-1d',
  label:     'ADBE DE Random Motion 1D',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Motion 1D',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Motion 1D',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomMotion1DNode);
