/**
 * @file ADBE DE Bounce On Beat Uncategorized node definition (uncategorized/adbe-de-bounce-on-beat).
 * An effector that applies the ADBE DE Bounce On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Bounce On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEBounceOnBeatNode = {
  type:      'uncategorized/adbe-de-bounce-on-beat',
  label:     'ADBE DE Bounce On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Bounce On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Bounce On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEBounceOnBeatNode);
