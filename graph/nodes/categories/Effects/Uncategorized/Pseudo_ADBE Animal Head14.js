/**
 * @file Pseudo/ADBE Animal Head14 Uncategorized node definition (uncategorized/pseudo-adbe-animal-head14).
 * An effector that applies the Pseudo/ADBE Animal Head14 effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Animal Head14.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBEAnimalHead14Node = {
  type:      'uncategorized/pseudo-adbe-animal-head14',
  label:     'Pseudo/ADBE Animal Head14',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Animal Head14',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Animal Head14',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBEAnimalHead14Node);
