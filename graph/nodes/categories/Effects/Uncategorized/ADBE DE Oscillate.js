/**
 * @file ADBE DE Oscillate Uncategorized node definition (uncategorized/adbe-de-oscillate).
 * An effector that applies the ADBE DE Oscillate effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Oscillate.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOscillateNode = {
  type:      'uncategorized/adbe-de-oscillate',
  label:     'ADBE DE Oscillate',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Oscillate',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Oscillate',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOscillateNode);
