/**
 * @file Pseudo/@@xv+vsUUFR3ylaDbUnFFMhw Uncategorized node definition (uncategorized/pseudo-xvvsuufr3yladbunffmhw).
 * An effector that applies the Pseudo/@@xv+vsUUFR3ylaDbUnFFMhw effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_@@xv+vsUUFR3ylaDbUnFFMhw.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoxvvsUUFR3ylaDbUnFFMhwNode = {
  type:      'uncategorized/pseudo-xvvsuufr3yladbunffmhw',
  label:     'Pseudo/@@xv+vsUUFR3ylaDbUnFFMhw',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/@@xv+vsUUFR3ylaDbUnFFMhw',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/@@xv+vsUUFR3ylaDbUnFFMhw',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoxvvsUUFR3ylaDbUnFFMhwNode);
