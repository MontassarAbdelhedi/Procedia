/**
 * @file ADBE DE Jiggle Random Uncategorized node definition (uncategorized/adbe-de-jiggle-random).
 * An effector that applies the ADBE DE Jiggle Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Jiggle Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEJiggleRandomNode = {
  type:      'uncategorized/adbe-de-jiggle-random',
  label:     'ADBE DE Jiggle Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Jiggle Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Jiggle Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEJiggleRandomNode);
