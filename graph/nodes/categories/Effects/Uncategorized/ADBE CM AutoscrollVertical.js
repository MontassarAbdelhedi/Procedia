/**
 * @file ADBE CM AutoscrollVertical Uncategorized node definition (uncategorized/adbe-cm-autoscrollvertical).
 * An effector that applies the ADBE CM AutoscrollVertical effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM AutoscrollVertical.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMAutoscrollVerticalNode = {
  type:      'uncategorized/adbe-cm-autoscrollvertical',
  label:     'ADBE CM AutoscrollVertical',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM AutoscrollVertical',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM AutoscrollVertical',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMAutoscrollVerticalNode);
