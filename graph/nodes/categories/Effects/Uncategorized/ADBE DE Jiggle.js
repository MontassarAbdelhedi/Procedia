/**
 * @file ADBE DE Jiggle Uncategorized node definition (uncategorized/adbe-de-jiggle).
 * An effector that applies the ADBE DE Jiggle effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Jiggle.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEJiggleNode = {
  type:      'uncategorized/adbe-de-jiggle',
  label:     'ADBE DE Jiggle',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Jiggle',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Jiggle',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEJiggleNode);
