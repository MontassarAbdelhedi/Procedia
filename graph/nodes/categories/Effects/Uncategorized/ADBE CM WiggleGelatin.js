/**
 * @file ADBE CM WiggleGelatin Uncategorized node definition (uncategorized/adbe-cm-wigglegelatin).
 * An effector that applies the ADBE CM WiggleGelatin effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM WiggleGelatin.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWiggleGelatinNode = {
  type:      'uncategorized/adbe-cm-wigglegelatin',
  label:     'ADBE CM WiggleGelatin',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM WiggleGelatin',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM WiggleGelatin',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWiggleGelatinNode);
