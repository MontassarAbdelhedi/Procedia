/**
 * @file ADBE CM Throw Uncategorized node definition (uncategorized/adbe-cm-throw).
 * An effector that applies the ADBE CM Throw effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM Throw.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMThrowNode = {
  type:      'uncategorized/adbe-cm-throw',
  label:     'ADBE CM Throw',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM Throw',
  params:    'dynamic',
...
nodeRegistry.register(ADBECMThrowNode);
