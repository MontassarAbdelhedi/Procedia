/**
 * @file ADBE DE Opacity Pulse On Beat Uncategorized node definition (uncategorized/adbe-de-opacity-pulse-on-beat).
 * An effector that applies the ADBE DE Opacity Pulse On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Opacity Pulse On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOpacityPulseOnBeatNode = {
  type:      'uncategorized/adbe-de-opacity-pulse-on-beat',
  label:     'ADBE DE Opacity Pulse On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Opacity Pulse On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Opacity Pulse On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOpacityPulseOnBeatNode);
