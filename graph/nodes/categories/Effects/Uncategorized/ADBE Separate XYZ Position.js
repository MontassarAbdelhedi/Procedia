/**
 * @file ADBE Separate XYZ Position Uncategorized node definition (uncategorized/adbe-separate-xyz-position).
 * An effector that applies the ADBE Separate XYZ Position effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE Separate XYZ Position.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBESeparateXYZPositionNode = {
  type:      'uncategorized/adbe-separate-xyz-position',
  label:     'ADBE Separate XYZ Position',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Separate XYZ Position',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Separate XYZ Position',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBESeparateXYZPositionNode);
