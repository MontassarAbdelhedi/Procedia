/**
 * @file ADBE DE Random Fill Color Uncategorized node definition (uncategorized/adbe-de-random-fill-color).
 * An effector that applies the ADBE DE Random Fill Color effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Fill Color.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomFillColorNode = {
  type:      'uncategorized/adbe-de-random-fill-color',
  label:     'ADBE DE Random Fill Color',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Fill Color',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Fill Color',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomFillColorNode);
