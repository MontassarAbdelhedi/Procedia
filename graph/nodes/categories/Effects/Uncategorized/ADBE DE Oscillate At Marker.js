/**
 * @file ADBE DE Oscillate At Marker Uncategorized node definition (uncategorized/adbe-de-oscillate-at-marker).
 * An effector that applies the ADBE DE Oscillate At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Oscillate At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOscillateAtMarkerNode = {
  type:      'uncategorized/adbe-de-oscillate-at-marker',
  label:     'ADBE DE Oscillate At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Oscillate At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Oscillate At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOscillateAtMarkerNode);
