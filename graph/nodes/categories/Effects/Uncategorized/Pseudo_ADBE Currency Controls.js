/**
 * @file Pseudo/ADBE Currency Controls Uncategorized node definition (uncategorized/pseudo-adbe-currency-controls).
 * An effector that applies the Pseudo/ADBE Currency Controls effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Currency Controls.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBECurrencyControlsNode = {
  type:      'uncategorized/pseudo-adbe-currency-controls',
  label:     'Pseudo/ADBE Currency Controls',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Currency Controls',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Currency Controls',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBECurrencyControlsNode);
