/**
 * @file Pseudo/@@mWb1naWiTDa/yT6uBlXNYQ Uncategorized node definition (uncategorized/pseudo-mwb1nawitda-yt6ublxnyq).
 * An effector that applies the Pseudo/@@mWb1naWiTDa/yT6uBlXNYQ effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_@@mWb1naWiTDa_yT6uBlXNYQ.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudomWb1naWiTDayT6uBlXNYQNode = {
  type:      'uncategorized/pseudo-mwb1nawitda-yt6ublxnyq',
  label:     'Pseudo/@@mWb1naWiTDa/yT6uBlXNYQ',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/@@mWb1naWiTDa/yT6uBlXNYQ',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/@@mWb1naWiTDa/yT6uBlXNYQ',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudomWb1naWiTDayT6uBlXNYQNode);
