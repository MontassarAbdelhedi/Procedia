/**
 * @file ADBE CM MoodLightAmorph Uncategorized node definition (uncategorized/adbe-cm-moodlightamorph).
 * An effector that applies the ADBE CM MoodLightAmorph effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM MoodLightAmorph.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMMoodLightAmorphNode = {
  type:      'uncategorized/adbe-cm-moodlightamorph',
  label:     'ADBE CM MoodLightAmorph',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM MoodLightAmorph',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM MoodLightAmorph',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMMoodLightAmorphNode);
