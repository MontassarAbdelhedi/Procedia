/**
 * @file ADBE DE Wobble Bounce At Marker Uncategorized node definition (uncategorized/adbe-de-wobble-bounce-at-marker).
 * An effector that applies the ADBE DE Wobble Bounce At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Wobble Bounce At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEWobbleBounceAtMarkerNode = {
  type:      'uncategorized/adbe-de-wobble-bounce-at-marker',
  label:     'ADBE DE Wobble Bounce At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Wobble Bounce At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Wobble Bounce At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEWobbleBounceAtMarkerNode);
