/**
 * @file ADBE CM TransSlide Uncategorized node definition (uncategorized/adbe-cm-transslide).
 * An effector that applies the ADBE CM TransSlide effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransSlide.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransSlideNode = {
  type:      'uncategorized/adbe-cm-transslide',
  label:     'ADBE CM TransSlide',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransSlide',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransSlide',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransSlideNode);
