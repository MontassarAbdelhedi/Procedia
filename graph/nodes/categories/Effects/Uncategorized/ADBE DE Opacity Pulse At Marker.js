/**
 * @file ADBE DE Opacity Pulse At Marker Uncategorized node definition (uncategorized/adbe-de-opacity-pulse-at-marker).
 * An effector that applies the ADBE DE Opacity Pulse At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Opacity Pulse At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOpacityPulseAtMarkerNode = {
  type:      'uncategorized/adbe-de-opacity-pulse-at-marker',
  label:     'ADBE DE Opacity Pulse At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Opacity Pulse At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Opacity Pulse At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOpacityPulseAtMarkerNode);
