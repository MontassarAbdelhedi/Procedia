/**
 * @file ADBE CM Wigglerama Uncategorized node definition (uncategorized/adbe-cm-wigglerama).
 * An effector that applies the ADBE CM Wigglerama effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM Wigglerama.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWiggleramaNode = {
  type:      'uncategorized/adbe-cm-wigglerama',
  label:     'ADBE CM Wigglerama',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM Wigglerama',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM Wigglerama',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWiggleramaNode);
