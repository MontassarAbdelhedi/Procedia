/**
 * @file ADBE CM TransComplete Uncategorized node definition (uncategorized/adbe-cm-transcomplete).
 * An effector that applies the ADBE CM TransComplete effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransComplete.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransCompleteNode = {
  type:      'uncategorized/adbe-cm-transcomplete',
  label:     'ADBE CM TransComplete',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransComplete',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransComplete',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransCompleteNode);
