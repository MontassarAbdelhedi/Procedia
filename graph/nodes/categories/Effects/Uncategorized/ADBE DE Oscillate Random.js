/**
 * @file ADBE DE Oscillate Random Uncategorized node definition (uncategorized/adbe-de-oscillate-random).
 * An effector that applies the ADBE DE Oscillate Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Oscillate Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOscillateRandomNode = {
  type:      'uncategorized/adbe-de-oscillate-random',
  label:     'ADBE DE Oscillate Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Oscillate Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Oscillate Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOscillateRandomNode);
