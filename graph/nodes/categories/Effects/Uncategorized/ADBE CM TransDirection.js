/**
 * @file ADBE CM TransDirection Uncategorized node definition (uncategorized/adbe-cm-transdirection).
 * An effector that applies the ADBE CM TransDirection effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransDirection.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransDirectionNode = {
  type:      'uncategorized/adbe-cm-transdirection',
  label:     'ADBE CM TransDirection',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransDirection',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransDirection',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransDirectionNode);
