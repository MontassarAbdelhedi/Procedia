/**
 * @file ADBE CM FadeInOutFrames Uncategorized node definition (uncategorized/adbe-cm-fadeinoutframes).
 * An effector that applies the ADBE CM FadeInOutFrames effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM FadeInOutFrames.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMFadeInOutFramesNode = {
  type:      'uncategorized/adbe-cm-fadeinoutframes',
  label:     'ADBE CM FadeInOutFrames',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM FadeInOutFrames',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM FadeInOutFrames',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMFadeInOutFramesNode);
