/**
 * @file Pseudo/ADBE Pattern Template Uncategorized node definition (uncategorized/pseudo-adbe-pattern-template).
 * An effector that applies the Pseudo/ADBE Pattern Template effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Pattern Template.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBEPatternTemplateNode = {
  type:      'uncategorized/pseudo-adbe-pattern-template',
  label:     'Pseudo/ADBE Pattern Template',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Pattern Template',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Pattern Template',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBEPatternTemplateNode);
