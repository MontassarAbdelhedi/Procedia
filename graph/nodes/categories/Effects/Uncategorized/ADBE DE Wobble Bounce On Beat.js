/**
 * @file ADBE DE Wobble Bounce On Beat Uncategorized node definition (uncategorized/adbe-de-wobble-bounce-on-beat).
 * An effector that applies the ADBE DE Wobble Bounce On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Wobble Bounce On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEWobbleBounceOnBeatNode = {
  type:      'uncategorized/adbe-de-wobble-bounce-on-beat',
  label:     'ADBE DE Wobble Bounce On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Wobble Bounce On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Wobble Bounce On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEWobbleBounceOnBeatNode);
