/**
 * @file ADBE DE Jiggle At Marker Uncategorized node definition (uncategorized/adbe-de-jiggle-at-marker).
 * An effector that applies the ADBE DE Jiggle At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Jiggle At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEJiggleAtMarkerNode = {
  type:      'uncategorized/adbe-de-jiggle-at-marker',
  label:     'ADBE DE Jiggle At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Jiggle At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Jiggle At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEJiggleAtMarkerNode);
