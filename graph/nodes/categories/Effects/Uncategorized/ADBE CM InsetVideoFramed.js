/**
 * @file ADBE CM InsetVideoFramed Uncategorized node definition (uncategorized/adbe-cm-insetvideoframed).
 * An effector that applies the ADBE CM InsetVideoFramed effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM InsetVideoFramed.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMInsetVideoFramedNode = {
  type:      'uncategorized/adbe-cm-insetvideoframed',
  label:     'ADBE CM InsetVideoFramed',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM InsetVideoFramed',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM InsetVideoFramed',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMInsetVideoFramedNode);
