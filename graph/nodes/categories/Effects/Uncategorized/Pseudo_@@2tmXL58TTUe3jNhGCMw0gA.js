/**
 * @file Pseudo/@@2tmXL58TTUe3jNhGCMw0gA Uncategorized node definition (uncategorized/pseudo-2tmxl58ttue3jnhgcmw0ga).
 * An effector that applies the Pseudo/@@2tmXL58TTUe3jNhGCMw0gA effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_@@2tmXL58TTUe3jNhGCMw0gA.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var Pseudo2tmXL58TTUe3jNhGCMw0gANode = {
  type:      'uncategorized/pseudo-2tmxl58ttue3jnhgcmw0ga',
  label:     'Pseudo/@@2tmXL58TTUe3jNhGCMw0gA',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/@@2tmXL58TTUe3jNhGCMw0gA',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/@@2tmXL58TTUe3jNhGCMw0gA',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Pseudo2tmXL58TTUe3jNhGCMw0gANode);
