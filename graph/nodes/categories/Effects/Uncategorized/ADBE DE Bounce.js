/**
 * @file ADBE DE Bounce Uncategorized node definition (uncategorized/adbe-de-bounce).
 * An effector that applies the ADBE DE Bounce effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Bounce.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEBounceNode = {
  type:      'uncategorized/adbe-de-bounce',
  label:     'ADBE DE Bounce',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Bounce',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Bounce',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEBounceNode);
