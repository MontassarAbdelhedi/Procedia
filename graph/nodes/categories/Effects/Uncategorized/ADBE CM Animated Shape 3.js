/**
 * @file ADBE CM Animated Shape 3 Uncategorized node definition (uncategorized/adbe-cm-animated-shape-3).
 * An effector that applies the ADBE CM Animated Shape 3 effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM Animated Shape 3.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMAnimatedShape3Node = {
  type:      'uncategorized/adbe-cm-animated-shape-3',
  label:     'ADBE CM Animated Shape 3',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM Animated Shape 3',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM Animated Shape 3',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMAnimatedShape3Node);
