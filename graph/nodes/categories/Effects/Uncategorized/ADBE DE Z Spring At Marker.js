/**
 * @file ADBE DE Z Spring At Marker Uncategorized node definition (uncategorized/adbe-de-z-spring-at-marker).
 * An effector that applies the ADBE DE Z Spring At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Z Spring At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEZSpringAtMarkerNode = {
  type:      'uncategorized/adbe-de-z-spring-at-marker',
  label:     'ADBE DE Z Spring At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Z Spring At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Z Spring At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEZSpringAtMarkerNode);
