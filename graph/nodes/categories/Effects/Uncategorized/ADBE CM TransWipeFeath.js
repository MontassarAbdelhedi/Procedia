/**
 * @file ADBE CM TransWipeFeath Uncategorized node definition (uncategorized/adbe-cm-transwipefeath).
 * An effector that applies the ADBE CM TransWipeFeath effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransWipeFeath.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransWipeFeathNode = {
  type:      'uncategorized/adbe-cm-transwipefeath',
  label:     'ADBE CM TransWipeFeath',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransWipeFeath',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransWipeFeath',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransWipeFeathNode);
