/**
 * @file ADBE CM TransFade Uncategorized node definition (uncategorized/adbe-cm-transfade).
 * An effector that applies the ADBE CM TransFade effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransFade.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransFadeNode = {
  type:      'uncategorized/adbe-cm-transfade',
  label:     'ADBE CM TransFade',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransFade',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransFade',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransFadeNode);
