/**
 * @file ADBE DE Wobble Bounce Uncategorized node definition (uncategorized/adbe-de-wobble-bounce).
 * An effector that applies the ADBE DE Wobble Bounce effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Wobble Bounce.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEWobbleBounceNode = {
  type:      'uncategorized/adbe-de-wobble-bounce',
  label:     'ADBE DE Wobble Bounce',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Wobble Bounce',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Wobble Bounce',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEWobbleBounceNode);
