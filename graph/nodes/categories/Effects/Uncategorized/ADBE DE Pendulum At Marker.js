/**
 * @file ADBE DE Pendulum At Marker Uncategorized node definition (uncategorized/adbe-de-pendulum-at-marker).
 * An effector that applies the ADBE DE Pendulum At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pendulum At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPendulumAtMarkerNode = {
  type:      'uncategorized/adbe-de-pendulum-at-marker',
  label:     'ADBE DE Pendulum At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pendulum At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pendulum At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPendulumAtMarkerNode);
