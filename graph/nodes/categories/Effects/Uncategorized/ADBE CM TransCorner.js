/**
 * @file ADBE CM TransCorner Uncategorized node definition (uncategorized/adbe-cm-transcorner).
 * An effector that applies the ADBE CM TransCorner effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransCorner.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransCornerNode = {
  type:      'uncategorized/adbe-cm-transcorner',
  label:     'ADBE CM TransCorner',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransCorner',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransCorner',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransCornerNode);
