/**
 * @file ADBE CM ZoomWobble Uncategorized node definition (uncategorized/adbe-cm-zoomwobble).
 * An effector that applies the ADBE CM ZoomWobble effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM ZoomWobble.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMZoomWobbleNode = {
  type:      'uncategorized/adbe-cm-zoomwobble',
  label:     'ADBE CM ZoomWobble',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM ZoomWobble',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM ZoomWobble',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMZoomWobbleNode);
