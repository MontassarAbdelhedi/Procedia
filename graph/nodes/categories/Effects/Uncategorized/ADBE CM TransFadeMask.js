/**
 * @file ADBE CM TransFadeMask Uncategorized node definition (uncategorized/adbe-cm-transfademask).
 * An effector that applies the ADBE CM TransFadeMask effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransFadeMask.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransFadeMaskNode = {
  type:      'uncategorized/adbe-cm-transfademask',
  label:     'ADBE CM TransFadeMask',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransFadeMask',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransFadeMask',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransFadeMaskNode);
