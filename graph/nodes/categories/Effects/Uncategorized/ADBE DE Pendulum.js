/**
 * @file ADBE DE Pendulum Uncategorized node definition (uncategorized/adbe-de-pendulum).
 * An effector that applies the ADBE DE Pendulum effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pendulum.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPendulumNode = {
  type:      'uncategorized/adbe-de-pendulum',
  label:     'ADBE DE Pendulum',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pendulum',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pendulum',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPendulumNode);
