/**
 * @file ADBE CM TransCard Uncategorized node definition (uncategorized/adbe-cm-transcard).
 * An effector that applies the ADBE CM TransCard effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransCard.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransCardNode = {
  type:      'uncategorized/adbe-cm-transcard',
  label:     'ADBE CM TransCard',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransCard',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransCard',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransCardNode);
