/**
 * @file ADBE CM WigglePosition Uncategorized node definition (uncategorized/adbe-cm-wiggleposition).
 * An effector that applies the ADBE CM WigglePosition effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM WigglePosition.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWigglePositionNode = {
  type:      'uncategorized/adbe-cm-wiggleposition',
  label:     'ADBE CM WigglePosition',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM WigglePosition',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM WigglePosition',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWigglePositionNode);
