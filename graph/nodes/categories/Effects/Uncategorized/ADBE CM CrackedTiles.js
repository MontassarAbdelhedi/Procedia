/**
 * @file ADBE CM CrackedTiles Uncategorized node definition (uncategorized/adbe-cm-crackedtiles).
 * An effector that applies the ADBE CM CrackedTiles effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM CrackedTiles.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMCrackedTilesNode = {
  type:      'uncategorized/adbe-cm-crackedtiles',
  label:     'ADBE CM CrackedTiles',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM CrackedTiles',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM CrackedTiles',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMCrackedTilesNode);
