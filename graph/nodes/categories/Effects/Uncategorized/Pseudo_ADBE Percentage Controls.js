/**
 * @file Pseudo/ADBE Percentage Controls Uncategorized node definition (uncategorized/pseudo-adbe-percentage-controls).
 * An effector that applies the Pseudo/ADBE Percentage Controls effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Percentage Controls.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBEPercentageControlsNode = {
  type:      'uncategorized/pseudo-adbe-percentage-controls',
  label:     'Pseudo/ADBE Percentage Controls',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Percentage Controls',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Percentage Controls',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBEPercentageControlsNode);
