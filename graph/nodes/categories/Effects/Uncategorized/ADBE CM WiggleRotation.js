/**
 * @file ADBE CM WiggleRotation Uncategorized node definition (uncategorized/adbe-cm-wigglerotation).
 * An effector that applies the ADBE CM WiggleRotation effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM WiggleRotation.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWiggleRotationNode = {
  type:      'uncategorized/adbe-cm-wigglerotation',
  label:     'ADBE CM WiggleRotation',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM WiggleRotation',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM WiggleRotation',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWiggleRotationNode);
