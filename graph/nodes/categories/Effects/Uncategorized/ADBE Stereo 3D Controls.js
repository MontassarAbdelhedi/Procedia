/**
 * @file ADBE Stereo 3D Controls Uncategorized node definition (uncategorized/adbe-stereo-3d-controls).
 * An effector that applies the ADBE Stereo 3D Controls effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE Stereo 3D Controls.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEStereo3DControlsNode = {
  type:      'uncategorized/adbe-stereo-3d-controls',
  label:     'ADBE Stereo 3D Controls',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Stereo 3D Controls',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Stereo 3D Controls',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEStereo3DControlsNode);
