/**
 * @file ADBE DE Bounce Random Uncategorized node definition (uncategorized/adbe-de-bounce-random).
 * An effector that applies the ADBE DE Bounce Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Bounce Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEBounceRandomNode = {
  type:      'uncategorized/adbe-de-bounce-random',
  label:     'ADBE DE Bounce Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Bounce Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Bounce Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEBounceRandomNode);
