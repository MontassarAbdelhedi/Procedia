/**
 * @file ADBE CM WiggleShear Uncategorized node definition (uncategorized/adbe-cm-wiggleshear).
 * An effector that applies the ADBE CM WiggleShear effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM WiggleShear.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWiggleShearNode = {
  type:      'uncategorized/adbe-cm-wiggleshear',
  label:     'ADBE CM WiggleShear',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM WiggleShear',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM WiggleShear',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWiggleShearNode);
