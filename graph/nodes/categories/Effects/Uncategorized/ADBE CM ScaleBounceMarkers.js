/**
 * @file ADBE CM ScaleBounceMarkers Uncategorized node definition (uncategorized/adbe-cm-scalebouncemarkers).
 * An effector that applies the ADBE CM ScaleBounceMarkers effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM ScaleBounceMarkers.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMScaleBounceMarkersNode = {
  type:      'uncategorized/adbe-cm-scalebouncemarkers',
  label:     'ADBE CM ScaleBounceMarkers',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM ScaleBounceMarkers',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM ScaleBounceMarkers',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMScaleBounceMarkersNode);
