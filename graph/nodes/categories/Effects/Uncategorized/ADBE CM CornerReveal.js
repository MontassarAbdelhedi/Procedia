/**
 * @file ADBE CM CornerReveal Uncategorized node definition (uncategorized/adbe-cm-cornerreveal).
 * An effector that applies the ADBE CM CornerReveal effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM CornerReveal.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMCornerRevealNode = {
  type:      'uncategorized/adbe-cm-cornerreveal',
  label:     'ADBE CM CornerReveal',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM CornerReveal',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM CornerReveal',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMCornerRevealNode);
