/**
 * @file ADBE Sample Image Uncategorized node definition (uncategorized/adbe-sample-image).
 * An effector that applies the ADBE Sample Image effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE Sample Image.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBESampleImageNode = {
  type:      'uncategorized/adbe-sample-image',
  label:     'ADBE Sample Image',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Sample Image',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Sample Image',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBESampleImageNode);
