/**
 * @file ADBE CM TransIris Uncategorized node definition (uncategorized/adbe-cm-transiris).
 * An effector that applies the ADBE CM TransIris effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransIris.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransIrisNode = {
  type:      'uncategorized/adbe-cm-transiris',
  label:     'ADBE CM TransIris',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransIris',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransIris',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransIrisNode);
