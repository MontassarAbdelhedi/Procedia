/**
 * @file ADBE CM MoodLightStreaks Uncategorized node definition (uncategorized/adbe-cm-moodlightstreaks).
 * An effector that applies the ADBE CM MoodLightStreaks effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM MoodLightStreaks.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMMoodLightStreaksNode = {
  type:      'uncategorized/adbe-cm-moodlightstreaks',
  label:     'ADBE CM MoodLightStreaks',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM MoodLightStreaks',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM MoodLightStreaks',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMMoodLightStreaksNode);
