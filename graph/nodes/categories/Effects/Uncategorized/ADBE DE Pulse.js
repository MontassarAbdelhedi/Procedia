/**
 * @file ADBE DE Pulse Uncategorized node definition (uncategorized/adbe-de-pulse).
 * An effector that applies the ADBE DE Pulse effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pulse.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPulseNode = {
  type:      'uncategorized/adbe-de-pulse',
  label:     'ADBE DE Pulse',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pulse',
  params:    'dynamic',
...
nodeRegistry.register(ADBEDEPulseNode);
