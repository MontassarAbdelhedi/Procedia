/**
 * @file ADBE CM MoodLightDigital Uncategorized node definition (uncategorized/adbe-cm-moodlightdigital).
 * An effector that applies the ADBE CM MoodLightDigital effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM MoodLightDigital.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMMoodLightDigitalNode = {
  type:      'uncategorized/adbe-cm-moodlightdigital',
  label:     'ADBE CM MoodLightDigital',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM MoodLightDigital',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM MoodLightDigital',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMMoodLightDigitalNode);
