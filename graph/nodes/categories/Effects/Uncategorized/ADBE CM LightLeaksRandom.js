/**
 * @file ADBE CM LightLeaksRandom Uncategorized node definition (uncategorized/adbe-cm-lightleaksrandom).
 * An effector that applies the ADBE CM LightLeaksRandom effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM LightLeaksRandom.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMLightLeaksRandomNode = {
  type:      'uncategorized/adbe-cm-lightleaksrandom',
  label:     'ADBE CM LightLeaksRandom',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM LightLeaksRandom',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM LightLeaksRandom',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMLightLeaksRandomNode);
