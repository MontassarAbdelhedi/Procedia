/**
 * @file ADBE CM ScaleBounceRandom Uncategorized node definition (uncategorized/adbe-cm-scalebouncerandom).
 * An effector that applies the ADBE CM ScaleBounceRandom effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM ScaleBounceRandom.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMScaleBounceRandomNode = {
  type:      'uncategorized/adbe-cm-scalebouncerandom',
  label:     'ADBE CM ScaleBounceRandom',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM ScaleBounceRandom',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM ScaleBounceRandom',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMScaleBounceRandomNode);
