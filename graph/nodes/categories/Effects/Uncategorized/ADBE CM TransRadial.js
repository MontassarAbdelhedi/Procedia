/**
 * @file ADBE CM TransRadial Uncategorized node definition (uncategorized/adbe-cm-transradial).
 * An effector that applies the ADBE CM TransRadial effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransRadial.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransRadialNode = {
  type:      'uncategorized/adbe-cm-transradial',
  label:     'ADBE CM TransRadial',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransRadial',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransRadial',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransRadialNode);
