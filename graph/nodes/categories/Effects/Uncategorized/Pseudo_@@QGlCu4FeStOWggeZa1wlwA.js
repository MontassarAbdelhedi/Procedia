/**
 * @file Pseudo/@@QGlCu4FeStOWggeZa1wlwA Uncategorized node definition (uncategorized/pseudo-qglcu4festowggeza1wlwa).
 * An effector that applies the Pseudo/@@QGlCu4FeStOWggeZa1wlwA effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_@@QGlCu4FeStOWggeZa1wlwA.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoQGlCu4FeStOWggeZa1wlwANode = {
  type:      'uncategorized/pseudo-qglcu4festowggeza1wlwa',
  label:     'Pseudo/@@QGlCu4FeStOWggeZa1wlwA',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/@@QGlCu4FeStOWggeZa1wlwA',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/@@QGlCu4FeStOWggeZa1wlwA',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoQGlCu4FeStOWggeZa1wlwANode);
