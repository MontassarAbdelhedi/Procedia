/**
 * @file ADBE CM FadeInOutmsec Uncategorized node definition (uncategorized/adbe-cm-fadeinoutmsec).
 * An effector that applies the ADBE CM FadeInOutmsec effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM FadeInOutmsec.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMFadeInOutmsecNode = {
  type:      'uncategorized/adbe-cm-fadeinoutmsec',
  label:     'ADBE CM FadeInOutmsec',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM FadeInOutmsec',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM FadeInOutmsec',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMFadeInOutmsecNode);
