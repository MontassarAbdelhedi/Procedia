/**
 * @file ADBE DE Oscillate On Beat Uncategorized node definition (uncategorized/adbe-de-oscillate-on-beat).
 * An effector that applies the ADBE DE Oscillate On Beat effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Oscillate On Beat.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOscillateOnBeatNode = {
  type:      'uncategorized/adbe-de-oscillate-on-beat',
  label:     'ADBE DE Oscillate On Beat',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Oscillate On Beat',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Oscillate On Beat',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOscillateOnBeatNode);
