/**
 * @file ADBE DE Random Rotation Uncategorized node definition (uncategorized/adbe-de-random-rotation).
 * An effector that applies the ADBE DE Random Rotation effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Rotation.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomRotationNode = {
  type:      'uncategorized/adbe-de-random-rotation',
  label:     'ADBE DE Random Rotation',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Rotation',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Rotation',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomRotationNode);
