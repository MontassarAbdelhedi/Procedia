/**
 * @file ADBE DE Pendulum Random Uncategorized node definition (uncategorized/adbe-de-pendulum-random).
 * An effector that applies the ADBE DE Pendulum Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pendulum Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPendulumRandomNode = {
  type:      'uncategorized/adbe-de-pendulum-random',
  label:     'ADBE DE Pendulum Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pendulum Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pendulum Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPendulumRandomNode);
