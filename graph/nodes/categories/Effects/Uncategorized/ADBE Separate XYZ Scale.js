/**
 * @file ADBE Separate XYZ Scale Uncategorized node definition (uncategorized/adbe-separate-xyz-scale).
 * An effector that applies the ADBE Separate XYZ Scale effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE Separate XYZ Scale.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBESeparateXYZScaleNode = {
  type:      'uncategorized/adbe-separate-xyz-scale',
  label:     'ADBE Separate XYZ Scale',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Separate XYZ Scale',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Separate XYZ Scale',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBESeparateXYZScaleNode);
