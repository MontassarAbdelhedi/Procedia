/**
 * @file ADBE CM InsetVideoTorn Uncategorized node definition (uncategorized/adbe-cm-insetvideotorn).
 * An effector that applies the ADBE CM InsetVideoTorn effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM InsetVideoTorn.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMInsetVideoTornNode = {
  type:      'uncategorized/adbe-cm-insetvideotorn',
  label:     'ADBE CM InsetVideoTorn',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM InsetVideoTorn',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM InsetVideoTorn',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMInsetVideoTornNode);
