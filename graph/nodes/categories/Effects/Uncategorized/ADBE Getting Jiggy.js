/**
 * @file ADBE Getting Jiggy Uncategorized node definition (uncategorized/adbe-getting-jiggy).
 * An effector that applies the ADBE Getting Jiggy effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE Getting Jiggy.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEGettingJiggyNode = {
  type:      'uncategorized/adbe-getting-jiggy',
  label:     'ADBE Getting Jiggy',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Getting Jiggy',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Getting Jiggy',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEGettingJiggyNode);
