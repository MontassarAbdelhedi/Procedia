/**
 * @file ADBE DE Swarm Uncategorized node definition (uncategorized/adbe-de-swarm).
 * An effector that applies the ADBE DE Swarm effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Swarm.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDESwarmNode = {
  type:      'uncategorized/adbe-de-swarm',
  label:     'ADBE DE Swarm',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Swarm',
  params:    'dynamic',
...
nodeRegistry.register(ADBEDESwarmNode);
