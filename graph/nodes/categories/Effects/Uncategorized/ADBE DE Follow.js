/**
 * @file ADBE DE Follow Uncategorized node definition (uncategorized/adbe-de-follow).
 * An effector that applies the ADBE DE Follow effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Follow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEFollowNode = {
  type:      'uncategorized/adbe-de-follow',
  label:     'ADBE DE Follow',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Follow',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Follow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEFollowNode);
