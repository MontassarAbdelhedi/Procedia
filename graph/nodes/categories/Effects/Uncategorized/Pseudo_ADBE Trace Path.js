/**
 * @file Pseudo/ADBE Trace Path Uncategorized node definition (uncategorized/pseudo-adbe-trace-path).
 * An effector that applies the Pseudo/ADBE Trace Path effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Trace Path.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBETracePathNode = {
  type:      'uncategorized/pseudo-adbe-trace-path',
  label:     'Pseudo/ADBE Trace Path',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Trace Path',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Trace Path',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBETracePathNode);
