/**
 * @file ADBE CM ZoomBubble Uncategorized node definition (uncategorized/adbe-cm-zoombubble).
 * An effector that applies the ADBE CM ZoomBubble effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM ZoomBubble.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMZoomBubbleNode = {
  type:      'uncategorized/adbe-cm-zoombubble',
  label:     'ADBE CM ZoomBubble',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM ZoomBubble',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM ZoomBubble',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMZoomBubbleNode);
