/**
 * @file ADBE CM Animated Shape Control Uncategorized node definition (uncategorized/adbe-cm-animated-shape-control).
 * An effector that applies the ADBE CM Animated Shape Control effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM Animated Shape Control.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMAnimatedShapeControlNode = {
  type:      'uncategorized/adbe-cm-animated-shape-control',
  label:     'ADBE CM Animated Shape Control',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM Animated Shape Control',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM Animated Shape Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMAnimatedShapeControlNode);
