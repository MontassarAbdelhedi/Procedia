/**
 * @file ADBE DE Random Opacity Uncategorized node definition (uncategorized/adbe-de-random-opacity).
 * An effector that applies the ADBE DE Random Opacity effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Random Opacity.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomOpacityNode = {
  type:      'uncategorized/adbe-de-random-opacity',
  label:     'ADBE DE Random Opacity',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Opacity',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Opacity',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomOpacityNode);
