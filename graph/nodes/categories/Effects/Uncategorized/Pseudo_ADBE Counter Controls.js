/**
 * @file Pseudo/ADBE Counter Controls Uncategorized node definition (uncategorized/pseudo-adbe-counter-controls).
 * An effector that applies the Pseudo/ADBE Counter Controls effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/Pseudo_ADBE Counter Controls.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBECounterControlsNode = {
  type:      'uncategorized/pseudo-adbe-counter-controls',
  label:     'Pseudo/ADBE Counter Controls',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE Counter Controls',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE Counter Controls',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBECounterControlsNode);
