/**
 * @file ADBE DE Opacity Pulse Random Uncategorized node definition (uncategorized/adbe-de-opacity-pulse-random).
 * An effector that applies the ADBE DE Opacity Pulse Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Opacity Pulse Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOpacityPulseRandomNode = {
  type:      'uncategorized/adbe-de-opacity-pulse-random',
  label:     'ADBE DE Opacity Pulse Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Opacity Pulse Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Opacity Pulse Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOpacityPulseRandomNode);
