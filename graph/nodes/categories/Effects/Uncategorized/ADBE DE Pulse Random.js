/**
 * @file ADBE DE Pulse Random Uncategorized node definition (uncategorized/adbe-de-pulse-random).
 * An effector that applies the ADBE DE Pulse Random effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Pulse Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPulseRandomNode = {
  type:      'uncategorized/adbe-de-pulse-random',
  label:     'ADBE DE Pulse Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pulse Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pulse Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPulseRandomNode);
