/**
 * @file ADBE DE Orbit Uncategorized node definition (uncategorized/adbe-de-orbit).
 * An effector that applies the ADBE DE Orbit effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Orbit.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOrbitNode = {
  type:      'uncategorized/adbe-de-orbit',
  label:     'ADBE DE Orbit',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Orbit',
  params:    'dynamic',
...
nodeRegistry.register(ADBEDEOrbitNode);
