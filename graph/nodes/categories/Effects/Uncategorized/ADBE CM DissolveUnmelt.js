/**
 * @file ADBE CM DissolveUnmelt Uncategorized node definition (uncategorized/adbe-cm-dissolveunmelt).
 * An effector that applies the ADBE CM DissolveUnmelt effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM DissolveUnmelt.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMDissolveUnmeltNode = {
  type:      'uncategorized/adbe-cm-dissolveunmelt',
  label:     'ADBE CM DissolveUnmelt',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM DissolveUnmelt',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM DissolveUnmelt',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMDissolveUnmeltNode);
