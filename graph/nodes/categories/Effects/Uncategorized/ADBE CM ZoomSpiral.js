/**
 * @file ADBE CM ZoomSpiral Uncategorized node definition (uncategorized/adbe-cm-zoomspiral).
 * An effector that applies the ADBE CM ZoomSpiral effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM ZoomSpiral.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMZoomSpiralNode = {
  type:      'uncategorized/adbe-cm-zoomspiral',
  label:     'ADBE CM ZoomSpiral',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM ZoomSpiral',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM ZoomSpiral',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMZoomSpiralNode);
