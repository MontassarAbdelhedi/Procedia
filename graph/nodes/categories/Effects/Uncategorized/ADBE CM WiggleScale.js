/**
 * @file ADBE CM WiggleScale Uncategorized node definition (uncategorized/adbe-cm-wigglescale).
 * An effector that applies the ADBE CM WiggleScale effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM WiggleScale.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMWiggleScaleNode = {
  type:      'uncategorized/adbe-cm-wigglescale',
  label:     'ADBE CM WiggleScale',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM WiggleScale',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM WiggleScale',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMWiggleScaleNode);
