/**
 * @file ADBE CM TransWipe Uncategorized node definition (uncategorized/adbe-cm-transwipe).
 * An effector that applies the ADBE CM TransWipe effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM TransWipe.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransWipeNode = {
  type:      'uncategorized/adbe-cm-transwipe',
  label:     'ADBE CM TransWipe',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransWipe',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransWipe',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransWipeNode);
