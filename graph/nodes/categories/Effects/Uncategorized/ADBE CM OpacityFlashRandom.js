/**
 * @file ADBE CM OpacityFlashRandom Uncategorized node definition (uncategorized/adbe-cm-opacityflashrandom).
 * An effector that applies the ADBE CM OpacityFlashRandom effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE CM OpacityFlashRandom.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMOpacityFlashRandomNode = {
  type:      'uncategorized/adbe-cm-opacityflashrandom',
  label:     'ADBE CM OpacityFlashRandom',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM OpacityFlashRandom',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM OpacityFlashRandom',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMOpacityFlashRandomNode);
