/**
 * @file ADBE DE Bounce At Marker Uncategorized node definition (uncategorized/adbe-de-bounce-at-marker).
 * An effector that applies the ADBE DE Bounce At Marker effect to a layer.
...
// graph/nodes/categories/Effects/Uncategorized/ADBE DE Bounce At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEBounceAtMarkerNode = {
  type:      'uncategorized/adbe-de-bounce-at-marker',
  label:     'ADBE DE Bounce At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Bounce At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Bounce At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEBounceAtMarkerNode);
