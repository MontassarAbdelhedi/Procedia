/**
 * @file Fractal Noise Noise & Grain node definition (noise-grain/fractal-noise).
 * An effector that applies the ADBE Fractal Noise effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/FractalNoise.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var FractalNoiseNode = {
...
nodeRegistry.register(FractalNoiseNode);
