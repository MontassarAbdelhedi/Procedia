/**
 * @file VISINF Grain Implant Noise & Grain node definition (noise-grain/visinf-grain-implant).
 * An effector that applies the VISINF Grain Implant effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/VISINFGrainImplant.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var VISINFGrainImplantNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'VISINF Grain Implant',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(VISINFGrainImplantNode);
