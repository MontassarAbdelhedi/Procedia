/**
 * @file VISINF Grain Removal Noise & Grain node definition (noise-grain/visinf-grain-removal).
 * An effector that applies the VISINF Grain Removal effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/VISINFGrainRemoval.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var VISINFGrainRemovalNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'VISINF Grain Removal',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(VISINFGrainRemovalNode);
