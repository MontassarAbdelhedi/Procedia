/**
 * @file Noise HLS Auto 2 Noise & Grain node definition (noise-grain/noise-hls-auto-2).
 * An effector that applies the ADBE Noise HLS Auto2 effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/NoiseHLSAuto2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var NoiseHLSAuto2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise HLS Auto2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseHLSAuto2Node);
