/**
 * @file VISINF Grain Duplication Noise & Grain node definition (noise-grain/visinf-grain-duplication).
 * An effector that applies the VISINF Grain Duplication effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/VISINFGrainDuplication.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var VISINFGrainDuplicationNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'VISINF Grain Duplication',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(VISINFGrainDuplicationNode);
