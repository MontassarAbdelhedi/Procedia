/**
 * @file Noise Alpha 2 Noise & Grain node definition (noise-grain/noise-alpha-2).
 * An effector that applies the ADBE Noise Alpha2 effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/NoiseAlpha2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise Alpha2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseAlpha2Node);
