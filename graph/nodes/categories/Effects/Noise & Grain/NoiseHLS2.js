/**
 * @file Noise HLS 2 Noise & Grain node definition (noise-grain/noise-hls-2).
 * An effector that applies the ADBE Noise HLS2 effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/NoiseHLS2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Noise HLS2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(NoiseHLS2Node);
