/**
 * @file PS Median Noise & Grain node definition (noise-grain/ps-median).
 * An effector that applies the ADBE PS Median effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/PSMedian.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PS Median',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSMedianNode);
