/**
 * @file Median Noise & Grain node definition (noise-grain/median).
 * An effector that applies the ADBE Median effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/Median.js
...
nodeRegistry.register(MedianNode);
