/**
 * @file Noise 2 Noise & Grain node definition (noise-grain/noise-2).
 * An effector that applies the ADBE Noise2 effect to a layer.
...
// graph/nodes/categories/Effects/Noise & Grain/Noise2.js
...
nodeRegistry.register(Noise2Node);
