/**
 * @file CS LineSweep Transition node definition (transition/cs-line-sweep).
 * An effector that applies the CS LineSweep effect to a layer.
...
// graph/nodes/categories/Effects/Transition/CSLineSweep.js
...
nodeRegistry.register(CSLineSweepNode);
