/**
 * @file Iris Wipe Transition node definition (transition/iris-wipe).
 * An effector that applies the ADBE IRIS_WIPE effect to a layer.
...
// graph/nodes/categories/Effects/Transition/IrisWipe.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE IRIS_WIPE',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(IrisWipeNode);
