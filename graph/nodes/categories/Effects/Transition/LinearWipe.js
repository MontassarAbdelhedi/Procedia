/**
 * @file Linear Wipe Transition node definition (transition/linear-wipe).
 * An effector that applies the ADBE Linear Wipe effect to a layer.
...
// graph/nodes/categories/Effects/Transition/LinearWipe.js
...
nodeRegistry.register(LinearWipeNode);
