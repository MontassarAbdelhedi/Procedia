/**
 * @file CC Twister Transition node definition (transition/cc-twister).
 * An effector that applies the CC Twister effect to a layer.
...
// graph/nodes/categories/Effects/Transition/CCTwister.js
...
nodeRegistry.register(CCTwisterNode);
