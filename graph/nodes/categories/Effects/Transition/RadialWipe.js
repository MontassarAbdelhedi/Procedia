/**
 * @file Radial Wipe Transition node definition (transition/radial-wipe).
 * An effector that applies the ADBE Radial Wipe effect to a layer.
...
// graph/nodes/categories/Effects/Transition/RadialWipe.js
...
nodeRegistry.register(RadialWipeNode);
