/**
 * @file CC Jaws Transition node definition (transition/cc-jaws).
 * An effector that applies the CC Jaws effect to a layer.
...
// graph/nodes/categories/Effects/Transition/CCJaws.js
...
nodeRegistry.register(CCJawsNode);
