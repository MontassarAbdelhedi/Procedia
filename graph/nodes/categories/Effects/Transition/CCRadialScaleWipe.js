/**
 * @file CC Radial ScaleWipe Transition node definition (transition/cc-radial-scale-wipe).
 * An effector that applies the CC Radial ScaleWipe effect to a layer.
...
// graph/nodes/categories/Effects/Transition/CCRadialScaleWipe.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCRadialScaleWipeNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Radial ScaleWipe',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCRadialScaleWipeNode);
