/**
 * @file APC Card Wipe Cam Transition node definition (transition/apc-card-wipe-cam).
 * An effector that applies the APC CardWipeCam effect to a layer.
...
// graph/nodes/categories/Effects/Transition/APCCardWipeCam.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var APCCardWipeCamNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'APC CardWipeCam',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(APCCardWipeCamNode);
