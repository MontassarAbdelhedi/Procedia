/**
 * @file CC Grid Wipe Transition node definition (transition/cc-grid-wipe).
 * An effector that applies the CC Grid Wipe effect to a layer.
...
// graph/nodes/categories/Effects/Transition/CCGridWipe.js
...
nodeRegistry.register(CCGridWipeNode);
