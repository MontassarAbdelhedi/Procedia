/**
 * @file Gradient Wipe Transition node definition (transition/gradient-wipe).
 * An effector that applies the ADBE Gradient Wipe effect to a layer.
...
// graph/nodes/categories/Effects/Transition/GradientWipe.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var GradientWipeNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Gradient Wipe',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(GradientWipeNode);
