/**
 * @file Angle Control Expression Controls node definition (expression-controls/angle-control).
 * An effector that applies the ADBE Angle Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/AngleControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AngleControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Angle Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AngleControlNode);
