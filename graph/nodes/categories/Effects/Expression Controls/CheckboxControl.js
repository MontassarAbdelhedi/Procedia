/**
 * @file Checkbox Control Expression Controls node definition (expression-controls/checkbox-control).
 * An effector that applies the ADBE Checkbox Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/CheckboxControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CheckboxControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Checkbox Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CheckboxControlNode);
