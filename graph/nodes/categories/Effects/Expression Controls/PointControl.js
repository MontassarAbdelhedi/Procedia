/**
 * @file Point Control Expression Controls node definition (expression-controls/point-control).
 * An effector that applies the ADBE Point Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/PointControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PointControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Point Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PointControlNode);
