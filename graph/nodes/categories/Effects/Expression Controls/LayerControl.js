/**
 * @file Layer Control Expression Controls node definition (expression-controls/layer-control).
 * An effector that applies the ADBE Layer Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/LayerControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var LayerControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Layer Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(LayerControlNode);
