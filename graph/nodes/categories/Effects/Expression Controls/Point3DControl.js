/**
 * @file Point 3D Control Expression Controls node definition (expression-controls/point-3d-control).
 * An effector that applies the ADBE Point3D Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/Point3DControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var Point3DControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Point3D Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Point3DControlNode);
