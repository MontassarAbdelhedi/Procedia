/**
 * @file Dropdown Control Expression Controls node definition (expression-controls/dropdown-control).
 * An effector that applies the ADBE Dropdown Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/DropdownControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var DropdownControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Dropdown Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DropdownControlNode);
