/**
 * @file Color Control Expression Controls node definition (expression-controls/color-control).
 * An effector that applies the ADBE Color Control effect to a layer.
...
// graph/nodes/categories/Effects/Expression Controls/ColorControl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorControlNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Control',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorControlNode);
