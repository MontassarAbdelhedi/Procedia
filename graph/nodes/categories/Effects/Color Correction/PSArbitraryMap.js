/**
 * @file PS Arbitrary Map Color Correction node definition (color-correction/ps-arbitrary-map).
 * An effector that applies the ADBE PS Arbitrary Map effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/PSArbitraryMap.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PSArbitraryMapNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE PS Arbitrary Map',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PSArbitraryMapNode);
