/**
 * @file Color Balance 2 Color Correction node definition (color-correction/color-balance-2).
 * An effector that applies the ADBE Color Balance 2 effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/ColorBalance2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorBalance2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Balance 2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorBalance2Node);
