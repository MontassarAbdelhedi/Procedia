/**
 * @file Color Link Color Correction node definition (color-correction/color-link).
 * An effector that applies the ADBE Color Link effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/ColorLink.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Link',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorLinkNode);
