/**
 * @file OCIO Look Transform Color Correction node definition (color-correction/ocio-look-transform).
 * An effector that applies the ADBE OCIO Look Transform effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/OCIOLookTransform.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OCIOLookTransformNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OCIO Look Transform',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OCIOLookTransformNode);
