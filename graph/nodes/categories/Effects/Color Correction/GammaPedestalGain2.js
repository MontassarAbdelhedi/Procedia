/**
 * @file Gamma/Pedestal/Gain 2 Color Correction node definition (color-correction/gamma-pedestal-gain-2).
 * An effector that applies the ADBE Gamma/Pedestal/Gain2 effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/GammaPedestalGain2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var GammaPedestalGain2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Gamma/Pedestal/Gain2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(GammaPedestalGain2Node);
