/**
 * @file OCIO Color Space Transform Color Correction node definition (color-correction/ocio-color-space-transform).
 * An effector that applies the ADBE OCIO Color Space Transform effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/OCIOCSpaceTransform.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OCIOCSpaceTransformNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OCIO Color Space Transform',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OCIOCSpaceTransformNode);
