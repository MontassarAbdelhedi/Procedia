/**
 * @file Black & White Color Correction node definition (color-correction/black-white).
 * An effector that applies the ADBE Black&White effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/BlackWhite.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Black&White',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BlackWhiteNode);
