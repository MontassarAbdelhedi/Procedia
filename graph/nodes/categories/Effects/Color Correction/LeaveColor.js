/**
 * @file Leave Color Color Correction node definition (color-correction/leave-color).
 * An effector that applies the ADBE Leave Color effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/LeaveColor.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Leave Color',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(LeaveColorNode);
