/**
 * @file OCIO File Transform Color Correction node definition (color-correction/ocio-file-transform).
 * An effector that applies the ADBE OCIO FILE Transform effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/OCIOFileTransform.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OCIOFileTransformNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OCIO FILE Transform',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OCIOFileTransformNode);
