/**
 * @file OCIO Display Transform Color Correction node definition (color-correction/ocio-display-transform).
 * An effector that applies the ADBE OCIO Display Transform effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/OCIODisplayTransform.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OCIODisplayTransformNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OCIO Display Transform',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OCIODisplayTransformNode);
