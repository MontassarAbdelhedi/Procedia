/**
 * @file Digital Video Limiter Color Correction node definition (color-correction/digital-video-limiter).
 * An effector that applies the ADBE DigitalVideoLimiter effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/DigitalVideoLimiter.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var DigitalVideoLimiterNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DigitalVideoLimiter',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DigitalVideoLimiterNode);
