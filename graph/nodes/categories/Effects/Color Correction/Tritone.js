/**
 * @file Tritone Color Correction node definition (color-correction/tritone).
 * An effector that applies the ADBE Tritone effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/Tritone.js
...
nodeRegistry.register(TritoneNode);
