/**
 * @file Auto Contrast Color Correction node definition (color-correction/auto-contrast).
 * An effector that applies the ADBE AutoContrast effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/AutoContrast.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AutoContrastNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE AutoContrast',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AutoContrastNode);
