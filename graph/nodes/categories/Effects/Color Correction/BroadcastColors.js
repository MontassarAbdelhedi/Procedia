/**
 * @file Broadcast Colors Color Correction node definition (color-correction/broadcast-colors).
 * An effector that applies the ADBE Broadcast Colors effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/BroadcastColors.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var BroadcastColorsNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Broadcast Colors',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BroadcastColorsNode);
