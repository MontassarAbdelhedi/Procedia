/**
 * @file CS Color Neutralizer Color Correction node definition (color-correction/cs-color-neutralizer).
 * An effector that applies the CS Color Neutralizer effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/CSColorNeutralizer.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CSColorNeutralizerNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CS Color Neutralizer',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CSColorNeutralizerNode);
