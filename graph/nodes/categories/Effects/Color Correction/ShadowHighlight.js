/**
 * @file Shadow/Highlight Color Correction node definition (color-correction/shadow-highlight).
 * An effector that applies the ADBE ShadowHighlight effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/ShadowHighlight.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ShadowHighlightNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE ShadowHighlight',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ShadowHighlightNode);
