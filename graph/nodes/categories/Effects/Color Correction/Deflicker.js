/**
 * @file Deflicker Color Correction node definition (color-correction/deflicker).
 * An effector that applies the ADBE Deflicker effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/Deflicker.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Deflicker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DeflickerNode);
