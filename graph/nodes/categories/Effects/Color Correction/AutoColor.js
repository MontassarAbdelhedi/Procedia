/**
 * @file Auto Color Color Correction node definition (color-correction/auto-color).
 * An effector that applies the ADBE AutoColor effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/AutoColor.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE AutoColor',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AutoColorNode);
