/**
 * @file Auto Levels Color Correction node definition (color-correction/auto-levels).
 * An effector that applies the ADBE AutoLevels effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/AutoLevels.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE AutoLevels',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AutoLevelsNode);
