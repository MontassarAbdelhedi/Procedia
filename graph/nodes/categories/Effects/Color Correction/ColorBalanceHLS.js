/**
 * @file Color Balance (HLS) Color Correction node definition (color-correction/color-balance-hls).
 * An effector that applies the ADBE Color Balance (HLS) effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/ColorBalanceHLS.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorBalanceHLSNode = {
...
nodeRegistry.register(ColorBalanceHLSNode);
