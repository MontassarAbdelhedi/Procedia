/**
 * @file CC Toner Color Correction node definition (color-correction/cc-toner).
 * An effector that applies the CC Toner effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/CCToner.js
...
nodeRegistry.register(CCTonerNode);
