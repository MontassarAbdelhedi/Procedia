/**
 * @file Selective Color Color Correction node definition (color-correction/selective-color).
 * An effector that applies the ADBE SelectiveColor effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/SelectiveColor.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SelectiveColorNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE SelectiveColor',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SelectiveColorNode);
