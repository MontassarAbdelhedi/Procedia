/**
 * @file Change Color Color Correction node definition (color-correction/change-color).
 * An effector that applies the ADBE Change Color effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/ChangeColor.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Change Color',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ChangeColorNode);
