/**
 * @file Easy Levels 2 Color Correction node definition (color-correction/easy-levels-2).
 * An effector that applies the ADBE Easy Levels2 effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/EasyLevels2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Easy Levels2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(EasyLevels2Node);
