/**
 * @file OCIO CDL Transform Color Correction node definition (color-correction/ocio-cdl-transform).
 * An effector that applies the ADBE OCIO CDL Transform effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/OCIOCDLTransform.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OCIOCDLTransformNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OCIO CDL Transform',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OCIOCDLTransformNode);
