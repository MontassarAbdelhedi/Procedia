/**
 * @file Tint Color Correction node definition (color-correction/tint).
 * An effector that applies the ADBE Tint effect to a layer.
...
// graph/nodes/categories/Effects/Color Correction/Tint.js
...
nodeRegistry.register(TintNode);
