/**
 * @file Color Difference Key Keying node definition (keying/color-difference-key).
 * An effector that applies the ADBE Color Difference Key effect to a layer.
...
// graph/nodes/categories/Effects/Keying/ColorDifferenceKey.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ColorDifferenceKeyNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Difference Key',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorDifferenceKeyNode);
