/**
 * @file Key Cleaner Keying node definition (keying/key-cleaner).
 * An effector that applies the ADBE KeyCleaner effect to a layer.
...
// graph/nodes/categories/Effects/Keying/KeyCleaner.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE KeyCleaner',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(KeyCleanerNode);
