/**
 * @file ATG Extract Keying node definition (keying/atg-extract).
 * An effector that applies the ADBE ATG Extract effect to a layer.
...
// graph/nodes/categories/Effects/Keying/ATGExtract.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE ATG Extract',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ATGExtractNode);
