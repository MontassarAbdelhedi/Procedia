/**
 * @file Difference Matte 2 Keying node definition (keying/difference-matte-2).
 * An effector that applies the ADBE Difference Matte2 effect to a layer.
...
// graph/nodes/categories/Effects/Keying/DifferenceMatte2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var DifferenceMatte2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Difference Matte2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DifferenceMatte2Node);
