/**
 * @file Extract Keying node definition (keying/extract).
 * An effector that applies the ADBE Extract effect to a layer.
...
// graph/nodes/categories/Effects/Keying/Extract.js
...
nodeRegistry.register(ExtractNode);
