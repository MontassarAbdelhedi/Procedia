/**
 * @file Linear Color Key 2 Keying node definition (keying/linear-color-key-2).
 * An effector that applies the ADBE Linear Color Key2 effect to a layer.
...
// graph/nodes/categories/Effects/Keying/LinearColorKey2.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var LinearColorKey2Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Linear Color Key2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(LinearColorKey2Node);
