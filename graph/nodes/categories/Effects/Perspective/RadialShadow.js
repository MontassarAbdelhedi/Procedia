/**
 * @file Radial Shadow Perspective node definition (perspective/radial-shadow).
 * An effector that applies the ADBE Radial Shadow effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/RadialShadow.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var RadialShadowNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Radial Shadow',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(RadialShadowNode);
