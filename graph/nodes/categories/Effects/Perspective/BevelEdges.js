/**
 * @file Bevel Edges Perspective node definition (perspective/bevel-edges).
 * An effector that applies the ADBE Bevel Edges effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/BevelEdges.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Bevel Edges',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BevelEdgesNode);
