/**
 * @file Bevel Alpha Perspective node definition (perspective/bevel-alpha).
 * An effector that applies the ADBE Bevel Alpha effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/BevelAlpha.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Bevel Alpha',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(BevelAlphaNode);
