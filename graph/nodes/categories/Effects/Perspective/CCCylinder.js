/**
 * @file CC Cylinder Perspective node definition (perspective/cc-cylinder).
 * An effector that applies the CC Cylinder effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/CCCylinder.js
...
nodeRegistry.register(CCCylinderNode);
