/**
 * @file CC Environment Perspective node definition (perspective/cc-environment).
 * An effector that applies the CC Environment effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/CCEnvironment.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCEnvironmentNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Environment',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCEnvironmentNode);
