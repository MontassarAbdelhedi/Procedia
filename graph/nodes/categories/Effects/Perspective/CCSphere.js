/**
 * @file CC Sphere Perspective node definition (perspective/cc-sphere).
 * An effector that applies the CC Sphere effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/CCSphere.js
...
nodeRegistry.register(CCSphereNode);
