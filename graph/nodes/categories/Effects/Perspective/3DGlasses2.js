/**
 * @file 3D Glasses 2 Perspective node definition (perspective/3d-glasses-2).
 * An effector that applies the ADBE 3D Glasses2 effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/3DGlasses2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE 3D Glasses2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Glasses3D2Node);
