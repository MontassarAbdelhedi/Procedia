/**
 * @file 3D Tracker Perspective node definition (perspective/3d-tracker).
 * An effector that applies the ADBE 3D Tracker effect to a layer.
...
// graph/nodes/categories/Effects/Perspective/3DTracker.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE 3D Tracker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Tracker3DNode);
