/**
 * @file Polar Coordinates Distort node definition (distort/polar-coordinates).
 * An effector that applies the ADBE Polar Coordinates effect to a layer.
...
// graph/nodes/categories/Effects/Distort/PolarCoordinates.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PolarCoordinatesNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Polar Coordinates',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PolarCoordinatesNode);
