/**
 * @file Geometry 2 Distort node definition (distort/geometry-2).
 * An effector that applies the ADBE Geometry2 effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Geometry2.js
...
nodeRegistry.register(Geometry2Node);
