/**
 * @file Upscale Distort node definition (distort/upscale).
 * An effector that applies the ADBE Upscale effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Upscale.js
...
nodeRegistry.register(UpscaleNode);
