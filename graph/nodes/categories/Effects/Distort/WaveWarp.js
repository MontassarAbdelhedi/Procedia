/**
 * @file Wave Warp Distort node definition (distort/wave-warp).
 * An effector that applies the ADBE Wave Warp effect to a layer.
...
// graph/nodes/categories/Effects/Distort/WaveWarp.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Wave Warp',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(WaveWarpNode);
