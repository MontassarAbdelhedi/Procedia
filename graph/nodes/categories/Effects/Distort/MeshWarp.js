/**
 * @file Mesh Warp Distort node definition (distort/mesh-warp).
 * An effector that applies the ADBE MESH WARP effect to a layer.
...
// graph/nodes/categories/Effects/Distort/MeshWarp.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE MESH WARP',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(MeshWarpNode);
