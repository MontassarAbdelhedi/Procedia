/**
 * @file Bez Mesh Distort node definition (distort/bez-mesh).
 * An effector that applies the ADBE BEZMESH effect to a layer.
...
// graph/nodes/categories/Effects/Distort/BezMesh.js
...
nodeRegistry.register(BezMeshNode);
