/**
 * @file Spherize Distort node definition (distort/spherize).
 * An effector that applies the ADBE Spherize effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Spherize.js
...
nodeRegistry.register(SpherizeNode);
