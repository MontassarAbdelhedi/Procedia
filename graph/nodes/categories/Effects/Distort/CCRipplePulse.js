/**
 * @file CC Ripple Pulse Distort node definition (distort/cc-ripple-pulse).
 * An effector that applies the CC Ripple Pulse effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCRipplePulse.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCRipplePulseNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Ripple Pulse',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCRipplePulseNode);
