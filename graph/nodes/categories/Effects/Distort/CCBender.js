/**
 * @file CC Bender Distort node definition (distort/cc-bender).
 * An effector that applies the CC Bender effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCBender.js
...
nodeRegistry.register(CCBenderNode);
