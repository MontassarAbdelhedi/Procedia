/**
 * @file CC Lens Distort node definition (distort/cc-lens).
 * An effector that applies the CC Lens effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCLens.js
...
nodeRegistry.register(CCLensNode);
