/**
 * @file CC Split 2 Distort node definition (distort/cc-split-2).
 * An effector that applies the CC Split 2 effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCSplit2.js
...
nodeRegistry.register(CCSplit2Node);
