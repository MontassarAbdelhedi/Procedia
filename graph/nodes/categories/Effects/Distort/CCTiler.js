/**
 * @file CC Tiler Distort node definition (distort/cc-tiler).
 * An effector that applies the CC Tiler effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCTiler.js
...
nodeRegistry.register(CCTilerNode);
