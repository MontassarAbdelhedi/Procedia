/**
 * @file Liquify Distort node definition (distort/liquify).
 * An effector that applies the ADBE LIQUIFY effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Liquify.js
...
nodeRegistry.register(LiquifyNode);
