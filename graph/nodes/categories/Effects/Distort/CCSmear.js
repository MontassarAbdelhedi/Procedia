/**
 * @file CC Smear Distort node definition (distort/cc-smear).
 * An effector that applies the CC Smear effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCSmear.js
...
nodeRegistry.register(CCSmearNode);
