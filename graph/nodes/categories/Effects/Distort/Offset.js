/**
 * @file Offset Distort node definition (distort/offset).
 * An effector that applies the ADBE Offset effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Offset.js
...
nodeRegistry.register(OffsetNode);
