/**
 * @file CC Bend It Distort node definition (distort/cc-bend-it).
 * An effector that applies the CC Bend It effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCBendIt.js
...
nodeRegistry.register(CCBendItNode);
