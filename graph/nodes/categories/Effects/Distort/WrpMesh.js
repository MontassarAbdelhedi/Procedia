/**
 * @file Wrp Mesh Distort node definition (distort/wrp-mesh).
 * An effector that applies the ADBE WRPMESH effect to a layer.
...
// graph/nodes/categories/Effects/Distort/WrpMesh.js
...
nodeRegistry.register(WrpMeshNode);
