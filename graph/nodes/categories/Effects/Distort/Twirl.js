/**
 * @file Twirl Distort node definition (distort/twirl).
 * An effector that applies the ADBE Twirl effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Twirl.js
...
nodeRegistry.register(TwirlNode);
