/**
 * @file CC Slant Distort node definition (distort/cc-slant).
 * An effector that applies the CC Slant effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCSlant.js
...
nodeRegistry.register(CCSlantNode);
