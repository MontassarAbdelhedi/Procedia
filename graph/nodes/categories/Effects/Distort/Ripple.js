/**
 * @file Ripple Distort node definition (distort/ripple).
 * An effector that applies the ADBE Ripple effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Ripple.js
...
nodeRegistry.register(RippleNode);
