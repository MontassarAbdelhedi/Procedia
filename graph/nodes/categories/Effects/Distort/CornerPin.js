/**
 * @file Corner Pin Distort node definition (distort/corner-pin).
 * An effector that applies the ADBE Corner Pin effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CornerPin.js
...
nodeRegistry.register(CornerPinNode);
