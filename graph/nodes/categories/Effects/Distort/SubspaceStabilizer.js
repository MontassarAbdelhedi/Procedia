/**
 * @file Subspace Stabilizer Distort node definition (distort/subspace-stabilizer).
 * An effector that applies the ADBE SubspaceStabilizer effect to a layer.
...
// graph/nodes/categories/Effects/Distort/SubspaceStabilizer.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var SubspaceStabilizerNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE SubspaceStabilizer',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(SubspaceStabilizerNode);
