/**
 * @file Bulge Distort node definition (distort/bulge).
 * An effector that applies the ADBE Bulge effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Bulge.js
...
nodeRegistry.register(BulgeNode);
