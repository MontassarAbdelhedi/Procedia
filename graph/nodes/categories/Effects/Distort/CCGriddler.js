/**
 * @file CC Griddler Distort node definition (distort/cc-griddler).
 * An effector that applies the CC Griddler effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCGriddler.js
...
nodeRegistry.register(CCGriddlerNode);
