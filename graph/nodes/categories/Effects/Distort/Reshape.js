/**
 * @file Reshape Distort node definition (distort/reshape).
 * An effector that applies the ADBE RESHAPE effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Reshape.js
...
nodeRegistry.register(ReshapeNode);
