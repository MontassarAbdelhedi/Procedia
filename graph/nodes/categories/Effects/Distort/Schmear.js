/**
 * @file Schmear Distort node definition (distort/schmear).
 * An effector that applies the ADBE SCHMEAR effect to a layer.
...
// graph/nodes/categories/Effects/Distort/Schmear.js
...
nodeRegistry.register(SchmearNode);
