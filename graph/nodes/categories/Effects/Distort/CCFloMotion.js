/**
 * @file CC Flo Motion Distort node definition (distort/cc-flo-motion).
 * An effector that applies the CC Flo Motion effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCFloMotion.js
...
nodeRegistry.register(CCFloMotionNode);
