/**
 * @file CC Power Pin Distort node definition (distort/cc-power-pin).
 * An effector that applies the CC Power Pin effect to a layer.
...
// graph/nodes/categories/Effects/Distort/CCPowerPin.js
...
nodeRegistry.register(CCPowerPinNode);
