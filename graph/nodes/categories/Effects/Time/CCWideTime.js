/**
 * @file CC Wide Time Time node definition (time/cc-wide-time).
 * An effector that applies the CC Wide Time effect to a layer.
...
// graph/nodes/categories/Effects/Time/CCWideTime.js
...
nodeRegistry.register(CCWideTimeNode);
