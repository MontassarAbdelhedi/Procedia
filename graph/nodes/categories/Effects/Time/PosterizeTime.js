/**
 * @file Posterize Time Time node definition (time/posterize-time).
 * An effector that applies the ADBE Posterize Time effect to a layer.
...
// graph/nodes/categories/Effects/Time/PosterizeTime.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PosterizeTimeNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Posterize Time',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PosterizeTimeNode);
