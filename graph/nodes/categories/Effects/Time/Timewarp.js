/**
 * @file Timewarp Time node definition (time/timewarp).
 * An effector that applies the ADBE Timewarp effect to a layer.
...
// graph/nodes/categories/Effects/Time/Timewarp.js
...
nodeRegistry.register(TimewarpNode);
