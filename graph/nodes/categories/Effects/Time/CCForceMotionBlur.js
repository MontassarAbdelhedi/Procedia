/**
 * @file CC Force Motion Blur Time node definition (time/cc-force-motion-blur).
 * An effector that applies the CC Force Motion Blur effect to a layer.
...
// graph/nodes/categories/Effects/Time/CCForceMotionBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCForceMotionBlurNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Force Motion Blur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCForceMotionBlurNode);
