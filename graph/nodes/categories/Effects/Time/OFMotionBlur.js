/**
 * @file OF Motion Blur Time node definition (time/of-motion-blur).
 * An effector that applies the ADBE OFMotionBlur effect to a layer.
...
// graph/nodes/categories/Effects/Time/OFMotionBlur.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var OFMotionBlurNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE OFMotionBlur',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(OFMotionBlurNode);
