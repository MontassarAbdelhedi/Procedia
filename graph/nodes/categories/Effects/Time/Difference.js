/**
 * @file Difference Time node definition (time/difference).
 * An effector that applies the ADBE Difference effect to a layer.
...
// graph/nodes/categories/Effects/Time/Difference.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Difference',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DifferenceNode);
