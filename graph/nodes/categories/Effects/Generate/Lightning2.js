/**
 * @file Lightning 2 Generate node definition (generate/lightning-2).
 * An effector that applies the ADBE Lightning 2 effect to a layer.
...
// graph/nodes/categories/Effects/Generate/Lightning2.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Lightning 2',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(Lightning2Node);
