/**
 * @file CS Threads Generate node definition (generate/cs-threads).
 * An effector that applies the CS Threads effect to a layer.
...
// graph/nodes/categories/Effects/Generate/CSThreads.js
...
nodeRegistry.register(CSThreadsNode);
