/**
 * @file CC Light Sweep Generate node definition (generate/cc-light-sweep).
 * An effector that applies the CC Light Sweep effect to a layer.
...
// graph/nodes/categories/Effects/Generate/CCLightSweep.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCLightSweepNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Light Sweep',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCLightSweepNode);
