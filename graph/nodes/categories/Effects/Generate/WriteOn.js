/**
 * @file Write-on Generate node definition (generate/write-on).
 * An effector that applies the ADBE Write-on effect to a layer.
...
// graph/nodes/categories/Effects/Generate/WriteOn.js
...
nodeRegistry.register(WriteOnNode);
