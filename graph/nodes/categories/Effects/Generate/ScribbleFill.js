/**
 * @file Scribble Fill Generate node definition (generate/scribble-fill).
 * An effector that applies the ADBE Scribble Fill effect to a layer.
...
// graph/nodes/categories/Effects/Generate/ScribbleFill.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ScribbleFillNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Scribble Fill',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ScribbleFillNode);
