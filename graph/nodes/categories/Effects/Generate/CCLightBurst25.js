/**
 * @file CC Light Burst 2.5 Generate node definition (generate/cc-light-burst-2-5).
 * An effector that applies the CC Light Burst 2.5 effect to a layer.
...
// graph/nodes/categories/Effects/Generate/CCLightBurst25.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCLightBurst25Node = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Light Burst 2.5',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCLightBurst25Node);
