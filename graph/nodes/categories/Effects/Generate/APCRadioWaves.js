/**
 * @file APC Radio Waves Generate node definition (generate/apc-radio-waves).
 * An effector that applies the APC Radio Waves effect to a layer.
...
// graph/nodes/categories/Effects/Generate/APCRadioWaves.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var APCRadioWavesNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'APC Radio Waves',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(APCRadioWavesNode);
