/**
 * @file Cell Pattern Generate node definition (generate/cell-pattern).
 * An effector that applies the ADBE Cell Pattern effect to a layer.
...
// graph/nodes/categories/Effects/Generate/CellPattern.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Cell Pattern',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CellPatternNode);
