/**
 * @file Eyedropper Fill Generate node definition (generate/eyedropper-fill).
 * An effector that applies the ADBE Eyedropper Fill effect to a layer.
...
// graph/nodes/categories/Effects/Generate/EyedropperFill.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var EyedropperFillNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Eyedropper Fill',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(EyedropperFillNode);
