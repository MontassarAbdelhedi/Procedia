/**
 * @file CC Glue Gun Generate node definition (generate/cc-glue-gun).
 * An effector that applies the CC Glue Gun effect to a layer.
...
// graph/nodes/categories/Effects/Generate/CCGlueGun.js
...
nodeRegistry.register(CCGlueGunNode);
