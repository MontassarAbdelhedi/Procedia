/**
 * @file Paint Bucket Generate node definition (generate/paint-bucket).
 * An effector that applies the ADBE Paint Bucket effect to a layer.
...
// graph/nodes/categories/Effects/Generate/PaintBucket.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Paint Bucket',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PaintBucketNode);
