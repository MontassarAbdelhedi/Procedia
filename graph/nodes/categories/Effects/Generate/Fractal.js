/**
 * @file Fractal Generate node definition (generate/fractal).
 * An effector that applies the ADBE Fractal effect to a layer.
...
// graph/nodes/categories/Effects/Generate/Fractal.js
...
nodeRegistry.register(FractalNode);
