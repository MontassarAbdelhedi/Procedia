/**
 * @file CC Split Distort node definition (distort/cc-split).
 * An effector that applies the CC Split effect to a layer.
...
// graph/nodes/categories/Distort/CCSplit.js
...
nodeRegistry.register(CCSplitNode);