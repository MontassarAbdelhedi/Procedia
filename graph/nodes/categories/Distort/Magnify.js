/**
 * @file Magnify Distort node definition (distort/magnify).
 * An effector that applies the ADBE Magnify effect to a layer.
...
// graph/nodes/categories/Distort/Magnify.js
...
nodeRegistry.register(MagnifyNode);