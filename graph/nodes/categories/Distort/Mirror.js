/**
 * @file Mirror Distort node definition (distort/mirror).
 * An effector that applies the ADBE Mirror effect to a layer.
...
// graph/nodes/categories/Distort/Mirror.js
...
nodeRegistry.register(MirrorNode);