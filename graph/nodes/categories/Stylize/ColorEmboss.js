/**
 * @file Color Emboss Stylize node definition (stylize/color-emboss).
 * An effector that applies the ADBE Color Emboss effect to a layer.
...
// graph/nodes/categories/Stylize/ColorEmboss.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Emboss',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorEmbossNode);