/**
 * @file CC RepeTile Stylize node definition (stylize/cc-repe-tile).
 * An effector that applies the CC RepeTile effect to a layer.
...
// graph/nodes/categories/Stylize/CCRepeTile.js
...
nodeRegistry.register(CCRepeTileNode);