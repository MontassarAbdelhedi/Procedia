/**
 * @file Gear shape node definition (shapes/gear).
 * A parametric gear shape with teeth, radii, fill, stroke, transform.
 * Ports: output (layer), secondaryInput (data) for each param, child_of/parent_of (parent).
 * Params: label, teeth, outerRadius, innerRadius, toothDepth, fill, stroke, position, rotation, scale, opacity.
 * Dispatches: createGearLayer, parkLayer, deleteParkedLayer, setLayerProperty.
 */

// graph/nodes/categories/Shapes/Gear.js
...
var GearNode = {
  ...
  ports: [
    ...
    { id: 'teeth',         category: 'secondaryInput', type: 'data',   capacity: 'single', label: 'Teeth' },
    ...
    { id: 'toothDepth',    category: 'secondaryInput', type: 'data',   capacity: 'single', label: 'Tooth Depth' },
  ...
  params: [
    { key: 'label',       type: 'string',  default: 'Gear',                label: 'Label' },
    { key: 'teeth',       type: 'number',  default: 12,                    label: 'Teeth',       min: 3, max: 64,       animatable: true },
    { key: 'outerRadius', type: 'number',  default: 100,                   label: 'Outer Radius', min: 1,                animatable: true },
    { key: 'innerRadius', type: 'number',  default: 70,                    label: 'Inner Radius', min: 1,                animatable: true },
    { key: 'toothDepth',  type: 'number',  default: 20,                    label: 'Tooth Depth',  min: 1,                animatable: true },
...
nodeRegistry.register(GearNode);
