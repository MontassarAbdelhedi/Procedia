/**
 * @file CC Light Wipe Transition node definition (transition/cc-light-wipe).
 * An effector that applies the CC Light Wipe effect to a layer.
...
// graph/nodes/categories/Transition/CCLightWipe.js
...
nodeRegistry.register(CCLightWipeNode);