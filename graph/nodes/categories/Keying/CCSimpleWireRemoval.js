/**
 * @file CC Simple Wire Removal Keying node definition (keying/cc-simple-wire-removal).
 * An effector that applies the CC Simple Wire Removal effect to a layer.
...
// graph/nodes/categories/Keying/CCSimpleWireRemoval.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCSimpleWireRemovalNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Simple Wire Removal',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCSimpleWireRemovalNode);