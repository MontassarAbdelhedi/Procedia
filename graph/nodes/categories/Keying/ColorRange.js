/**
 * @file Color Range Keying node definition (keying/color-range).
 * An effector that applies the ADBE Color Range effect to a layer.
...
// graph/nodes/categories/Keying/ColorRange.js
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Range',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ColorRangeNode);