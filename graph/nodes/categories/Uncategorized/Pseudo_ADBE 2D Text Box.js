/**
 * @file Pseudo/ADBE 2D Text Box Uncategorized node definition (uncategorized/pseudo-adbe-2d-text-box).
 * An effector that applies the Pseudo/ADBE 2D Text Box effect to a layer.
...
// graph/nodes/categories/Uncategorized/Pseudo_ADBE 2D Text Box.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var PseudoADBE2DTextBoxNode = {
  type:      'uncategorized/pseudo-adbe-2d-text-box',
  label:     'Pseudo/ADBE 2D Text Box',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'Pseudo/ADBE 2D Text Box',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'Pseudo/ADBE 2D Text Box',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(PseudoADBE2DTextBoxNode);