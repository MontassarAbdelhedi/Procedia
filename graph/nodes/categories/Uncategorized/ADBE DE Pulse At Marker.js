/**
 * @file ADBE DE Pulse At Marker Uncategorized node definition (uncategorized/adbe-de-pulse-at-marker).
 * An effector that applies the ADBE DE Pulse At Marker effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE DE Pulse At Marker.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEPulseAtMarkerNode = {
  type:      'uncategorized/adbe-de-pulse-at-marker',
  label:     'ADBE DE Pulse At Marker',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Pulse At Marker',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Pulse At Marker',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEPulseAtMarkerNode);