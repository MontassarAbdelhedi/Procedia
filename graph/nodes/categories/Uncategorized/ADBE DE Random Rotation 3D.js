/**
 * @file ADBE DE Random Rotation 3D Uncategorized node definition (uncategorized/adbe-de-random-rotation-3d).
 * An effector that applies the ADBE DE Random Rotation 3D effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE DE Random Rotation 3D.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDERandomRotation3DNode = {
  type:      'uncategorized/adbe-de-random-rotation-3d',
  label:     'ADBE DE Random Rotation 3D',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Random Rotation 3D',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Random Rotation 3D',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDERandomRotation3DNode);