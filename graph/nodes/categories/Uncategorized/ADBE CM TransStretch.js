/**
 * @file ADBE CM TransStretch Uncategorized node definition (uncategorized/adbe-cm-transstretch).
 * An effector that applies the ADBE CM TransStretch effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE CM TransStretch.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransStretchNode = {
  type:      'uncategorized/adbe-cm-transstretch',
  label:     'ADBE CM TransStretch',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransStretch',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransStretch',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransStretchNode);