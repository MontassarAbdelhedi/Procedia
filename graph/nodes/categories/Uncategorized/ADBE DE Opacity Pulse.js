/**
 * @file ADBE DE Opacity Pulse Uncategorized node definition (uncategorized/adbe-de-opacity-pulse).
 * An effector that applies the ADBE DE Opacity Pulse effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE DE Opacity Pulse.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEOpacityPulseNode = {
  type:      'uncategorized/adbe-de-opacity-pulse',
  label:     'ADBE DE Opacity Pulse',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Opacity Pulse',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Opacity Pulse',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEOpacityPulseNode);