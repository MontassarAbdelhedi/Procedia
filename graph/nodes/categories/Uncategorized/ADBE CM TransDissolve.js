/**
 * @file ADBE CM TransDissolve Uncategorized node definition (uncategorized/adbe-cm-transdissolve).
 * An effector that applies the ADBE CM TransDissolve effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE CM TransDissolve.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMTransDissolveNode = {
  type:      'uncategorized/adbe-cm-transdissolve',
  label:     'ADBE CM TransDissolve',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM TransDissolve',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM TransDissolve',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMTransDissolveNode);