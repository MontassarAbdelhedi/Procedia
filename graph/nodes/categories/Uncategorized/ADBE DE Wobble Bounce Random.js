/**
 * @file ADBE DE Wobble Bounce Random Uncategorized node definition (uncategorized/adbe-de-wobble-bounce-random).
 * An effector that applies the ADBE DE Wobble Bounce Random effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE DE Wobble Bounce Random.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEDEWobbleBounceRandomNode = {
  type:      'uncategorized/adbe-de-wobble-bounce-random',
  label:     'ADBE DE Wobble Bounce Random',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE DE Wobble Bounce Random',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE DE Wobble Bounce Random',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEDEWobbleBounceRandomNode);