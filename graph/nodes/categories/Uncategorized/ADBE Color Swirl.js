/**
 * @file ADBE Color Swirl Uncategorized node definition (uncategorized/adbe-color-swirl).
 * An effector that applies the ADBE Color Swirl effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE Color Swirl.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBEColorSwirlNode = {
  type:      'uncategorized/adbe-color-swirl',
  label:     'ADBE Color Swirl',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Color Swirl',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Color Swirl',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBEColorSwirlNode);