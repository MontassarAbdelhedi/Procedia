/**
 * @file ADBE CM LightLeaksMarkers Uncategorized node definition (uncategorized/adbe-cm-lightleaksmarkers).
 * An effector that applies the ADBE CM LightLeaksMarkers effect to a layer.
...
// graph/nodes/categories/Uncategorized/ADBE CM LightLeaksMarkers.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ADBECMLightLeaksMarkersNode = {
  type:      'uncategorized/adbe-cm-lightleaksmarkers',
  label:     'ADBE CM LightLeaksMarkers',
  category:  'Uncategorized',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE CM LightLeaksMarkers',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE CM LightLeaksMarkers',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ADBECMLightLeaksMarkersNode);