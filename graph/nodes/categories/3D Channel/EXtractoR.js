/**
 * @file EXtractoR 3D Channel node definition (3d-channel/extractor).
 * An effector that applies the EXtractoR effect to a layer.
...
// graph/nodes/categories/3D Channel/EXtractoR.js
...
nodeRegistry.register(EXtractoRNode);
