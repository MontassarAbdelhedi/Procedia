/**
 * @file Aux Channel Extract 3D Channel node definition (3d-channel/aux-channel-extract).
 * An effector that applies the ADBE AUX CHANNEL EXTRACT effect to a layer.
...
// graph/nodes/categories/3D Channel/AuxChannelExtract.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var AuxChannelExtractNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE AUX CHANNEL EXTRACT',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(AuxChannelExtractNode);
