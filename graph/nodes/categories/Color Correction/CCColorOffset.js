/**
 * @file CC Color Offset Color Correction node definition (color-correction/cc-color-offset).
 * An effector that applies the CC Color Offset effect to a layer.
...
// graph/nodes/categories/Color Correction/CCColorOffset.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var CCColorOffsetNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'CC Color Offset',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(CCColorOffsetNode);