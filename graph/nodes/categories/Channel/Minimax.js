/**
 * @file Minimax Channel node definition (channel/minimax).
 * An effector that applies the ADBE Minimax effect to a layer.
...
// graph/nodes/categories/Channel/Minimax.js
...
nodeRegistry.register(MinimaxNode);
