/**
 * @file Dust & Scratches Noise & Grain node definition (noise-grain/dust-scratches).
 * An effector that applies the ADBE Dust & Scratches effect to a layer.
...
// graph/nodes/categories/Noise & Grain/DustScratches.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var DustScratchesNode = {
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Dust & Scratches',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(DustScratchesNode);