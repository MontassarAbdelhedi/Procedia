/**
 * @file Three-Way Color Corrector Obsolete node definition (three-way-color-corrector).
 * An effector that applies the ADBE Three-Way Color Corrector effect to a layer.
...
// graph/nodes/categories/obsolete/ThreeWayColorCorrector.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var ThreeWayColorCorrectorNode = {
  type:      'obsolete/three-way-color-corrector',
  label:     'Three-Way Color Corrector',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Three-Way Color Corrector',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Three-Way Color Corrector',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(ThreeWayColorCorrectorNode);