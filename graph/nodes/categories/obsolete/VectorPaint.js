/**
 * @file Vector Paint Obsolete node definition (vector-paint).
 * An effector that applies the ADBE Vector Paint effect to a layer.
...
// graph/nodes/categories/obsolete/VectorPaint.js
// DEPENDS ON: graph/nodeRegistry.js
// MUST LOAD BEFORE: index.js

var VectorPaintNode = {
  type:      'obsolete/vector-paint',
  label:     'Vector Paint',
  category:  'obsolete',
  version:   '1.0.0',
  nodeKind:  'effector',
  dedicated: false,
  matchName: 'ADBE Vector Paint',
  params:    'dynamic',
  ...
  onPropertyChange: function(key, value, nodeData, hostingCompUUID, upstreamNodeUUID) {
    return {
      ...
      params: {
        ...
        hostingCompUUID: hostingCompUUID,
        layerNodeUUID:   upstreamNodeUUID,
        effectMatchName: 'ADBE Vector Paint',
        propMatchName:   key,
        value:           value
      }
    };
...
nodeRegistry.register(VectorPaintNode);