/**
 * @fileoverview Comp lifecycle handlers: create, delete, property set, focus (ES3-safe).
 * REQUIRES: json.jsx, utils.jsx
 * Load BEFORE: dispatcher.jsx (functions become globals for _handlers map)
 * Exports: _handleCreateComp, _handleDeleteComp, _handleSetCompProperty, _handleFocusComp
 */
// actionComp/compLifecycle.jsx — Comp lifecycle handlers (ES3-safe)
// REQUIRES: json.jsx, utils.jsx
